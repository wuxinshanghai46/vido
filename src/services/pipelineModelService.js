...
const NEW_STORY_AD_TEXT_DEFAULTS = [
  ...
  { provider_id: 'webang-maas', model_id: 'gemini-2.5-flash', priority: 6, enabled: false },
  { provider_id: 'webang-maas', model_id: 'gemini-2.5-pro', priority: 7, enabled: false },
  { provider_id: 'deepseek', model_id: 'deepseek-chat', priority: 8, enabled: false },
