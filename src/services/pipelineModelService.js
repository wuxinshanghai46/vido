...
const STAGE_DEFAULTS = {
  ...
  'luxury_ad.presenter_seed': [
    { provider_id: 'deyunai', model_id: 'nano-banana-pro', priority: 1, enabled: true },
    { provider_id: 'deyunai', model_id: 'nano-banana', priority: 2, enabled: true },
  ...
  'luxury_ad.subject_evidence_seed': [
    { provider_id: 'deyunai', model_id: 'qwen-image-edit', priority: 1, enabled: true },
    { provider_id: 'deyunai', model_id: 'qwen-image', priority: 2, enabled: true },
  ...
  'luxury_ad.keyframe': [
    ...
    { provider_id: 'deyunai', model_id: 'doubao-seedream-4-0-250828', priority: 5, enabled: true },
    { provider_id: 'deyunai', model_id: 'imagen-4', priority: 6, enabled: true },
    { provider_id: 'deyunai', model_id: 'flux-pro', priority: 7, enabled: true },
