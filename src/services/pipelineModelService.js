...
const STAGE_DEFAULTS = {
  ...
  'luxury_ad.presenter_seed': [
    ...
    { provider_id: 'topview', model_id: 'topview-nano-banana-pro', priority: 20, enabled: true },
  ],
  'luxury_ad.scene_seed': [
    ...
    { provider_id: 'deyunai', model_id: 'nano-banana', priority: 3, enabled: true },
    { provider_id: 'deyunai', model_id: 'qwen-image', priority: 4, enabled: true },
    { provider_id: 'topview', model_id: 'topview-seedream-5', priority: 20, enabled: true },
  ],
  'luxury_ad.subject_evidence_seed': [
    ...
    { provider_id: 'topview', model_id: 'topview-gpt-image-2', priority: 20, enabled: true },
  ],
  'luxury_ad.copy': [
    { provider_id: 'deepseek', model_id: 'deepseek-chat', priority: 1, enabled: true },
    { provider_id: 'deyunai', model_id: 'gemini-2.5-flash', priority: 2, enabled: true },
  ...
  'luxury_ad.keyframe': [
    { provider_id: 'deyunai', model_id: 'gpt-image-2', priority: 1, enabled: true },
    { provider_id: 'topview', model_id: 'topview-gpt-image-2', priority: 2, enabled: true },
    { provider_id: 'topview', model_id: 'topview-nano-banana-pro', priority: 3, enabled: true },
    { provider_id: 'topview', model_id: 'topview-seedream-5', priority: 4, enabled: true },
    { provider_id: 'topview', model_id: 'topview-nano-banana-2', priority: 5, enabled: true },
    { provider_id: 'deyunai', model_id: 'nano-banana-pro', priority: 6, enabled: true },
    { provider_id: 'deyunai', model_id: 'nano-banana', priority: 7, enabled: true },
    { provider_id: 'deyunai', model_id: 'qwen-image-edit', priority: 8, enabled: true },
    { provider_id: 'deyunai', model_id: 'qwen-image', priority: 9, enabled: true },
    { provider_id: 'deyunai', model_id: 'doubao-seedream-4-0-250828', priority: 10, enabled: true },
    { provider_id: 'deyunai', model_id: 'imagen-4', priority: 11, enabled: true },
    { provider_id: 'deyunai', model_id: 'flux-pro', priority: 12, enabled: true },
  ],
