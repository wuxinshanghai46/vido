...
const STAGE_DEFAULTS = {
  ...
  'luxury_ad.presenter_seed': [
    { provider_id: 'webang-maas', model_id: 'gpt-image-2', priority: 1, enabled: true },
    { provider_id: 'webang-maas', model_id: 'gemini-3.1-flash-image-preview', priority: 2, enabled: true },
    { provider_id: 'webang-maas', model_id: 'gemini-3.0-pro-image-preview', priority: 3, enabled: false },
    { provider_id: 'webang-maas', model_id: 'gemini-2.5-flash-image', priority: 4, enabled: true },
  ...
  'luxury_ad.keyframe_qa': [
    { provider_id: 'webang-maas', model_id: 'gemini-2.5-flash', priority: 1, enabled: true },
    { provider_id: 'webang-maas', model_id: 'gemini-2.5-pro', priority: 2, enabled: true },
    { provider_id: 'deyunai', model_id: 'gemini-2.5-flash', priority: 3, enabled: false },
    { provider_id: 'deyunai', model_id: 'gemini-2.5-pro', priority: 4, enabled: false },
