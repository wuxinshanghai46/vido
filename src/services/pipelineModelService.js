...
const STAGE_DEFAULTS = {
  ...
  'luxury_ad.scene_config': [
    { provider_id: 'deyunai', model_id: 'gpt-5.5', priority: 1, enabled: true },
    { provider_id: 'deyunai', model_id: 'gemini-2.5-pro', priority: 2, enabled: true },
    { provider_id: 'deyunai', model_id: 'claude-sonnet-4-6', priority: 3, enabled: true },
    { provider_id: 'deyunai', model_id: 'gpt-4o', priority: 4, enabled: true },
