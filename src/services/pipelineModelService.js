...
const PIPELINE_SCHEMA = {
  ...
  { id: 'new_story_ad.scene_config', name: '1 场景配置', type: 'story', desc: '把任务需求整理成独立上下文、主体、人物、素材和禁止项，不继承旧任务' },
    ...
    { id: 'new_story_ad.story_flow_planning', name: '3.0 人物场景语义绑定', type: 'story', desc: '在分镜生成内部把每个剧情节点绑定到已确认的人物与场景 ID；失败时在任何图片调用前停止' },
    ...
    { id: 'new_story_ad.storyboard_image', name: '剧情广告人物场景分镜', type: 'image', desc: '按已确认剧情流向合同生成并呈现绑定人物、场景、动作与机位的逐镜画面' },
    ...
    { id: 'new_story_ad.storyboard_subject_qa', name: '分镜主体数量与唯一性质检', type: 'vlm', desc: '检查分镜图主体数量、同身份重复与全行业主体合同一致性' },
...
const STAGE_DEFAULTS = {
  ...
  'new_story_ad.storyboard_subject_qa': NEW_STORY_AD_CONSISTENCY_VISION_DEFAULTS,
  ...
  'new_story_ad.story_flow_planning': NEW_STORY_AD_TEXT_DEFAULTS,
  ...
  'new_story_ad.video': [
    ...
    { provider_id: 'smscrw', model_id: 'doubao-seedance-2.0', priority: 2, enabled: true },
  ...
  'new_story_ad.sound_generation': [
    { provider_id: 'deyunai', model_id: 'doubao-seedance-2-0-260128', priority: 1, enabled: true },
    { provider_id: 'webang-seedance', model_id: 'doubao-seedance-2-0-260128', priority: 2, enabled: true },
