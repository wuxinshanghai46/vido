module.exports = [
  {
    ...
    summary: 'A project-level, multi-world contract for period, region, culture, fidelity and forbidden anachronisms.',
    content: 'Use one or more stable world profiles. User choices outrank brief facts, references and KB suggestions. Bind scenes and character looks to a profile. Separate historical realism, stylized history and fantasy. “Overseas” is incomplete until region or period is supplied. Keep required and forbidden elements compact; do not copy article-length prompts.',
    tags: ['world setting', 'era', 'region', 'fidelity', 'continuity'], keywords: ['world_setting_fidelity_contract', 'setting lock', 'historical realism'],
