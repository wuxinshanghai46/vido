...
5. 人物素材优先使用清晰正面大头照：竖图、肩部以上、中性表情、脸部约占画面三分之二、无遮挡。虚拟人物进入 AIGC 素材组；真人仅在授权流程完成后进入真人组。默认只传图片，不传视频。
...
- 禁止拆词、错别字、遮挡、变形、诱导描述或任何其它审核规避手段。`,
    ...
    keywords: ['25MB', '最多6张参考图', 'AIGC人物素材', '正面大头照', 'moderation preflight', 'Image 2 compliance'],
    prompt_snippets: [
      '人物合规前置：明确成年人和具体年龄，使用自然非暗示姿势；仅使用原创合成人物或可验证授权肖像。',
      '风格合规改写：删除未授权名人、角色、品牌、Logo、作品名和在世创作者姓名，改写为可观察的光线、色彩、镜头、材质与构图参数。',
      '参考图默认不超过 6 张且单张小于 25MB；人物优先正面肩上大头照，虚拟人物进入 AIGC 素材组，默认不上传视频。',
    ],
    applies_to: ['director', 'art_director', 'prompt_engineer', 'project_assistant', 'test_engineer'],
