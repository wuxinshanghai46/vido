...
const PROVIDER_PRESETS = {
  ...
  //   - 海外 Chat：https://api.deyunai.com/c35/v1（按官方契约配置真实 vendor；缺失时调用前隔离）
  //   - 海外 Claude Messages：https://api.deyunai.com/c35/v1/messages（官方示例不要求 vendor）
  ...
  'webang-maas': { name: '微众 MaaS（OpenAI 兼容）', api_url: 'https://tk.iserviceapi.com/api/v1', defaultModels: [
    ...
    { id: 'gpt-5.6-luna', name: 'GPT-5.6 Luna（轻量）', type: 'chat', use: 'story' },
    { id: 'gpt-5.4', name: 'GPT-5.4', type: 'chat', use: 'story', enabled: false },
    { id: 'claude-opus-5', name: 'Claude Opus 5（供应商支持·商务待启用）', type: 'chat', use: 'story', enabled: false },
    { id: 'claude-opus-4-8', name: 'Claude Opus 4.8', type: 'chat', use: 'story', enabled: false },
    { id: 'claude-opus-4-7', name: 'Claude Opus 4.7', type: 'chat', use: 'story', enabled: false },
    { id: 'claude-sonnet-4-6', name: 'Claude Sonnet 4.6', type: 'chat', use: 'story', enabled: false },
    ...
    { id: 'gemini-3.5-flash', name: 'Gemini 3.5 Flash（供应商新增）', type: 'chat', use: 'story' },
    ...
    { id: 'gemini-3.1-flash-image-preview', name: 'Nano Banana 2 Lite（gemini-3.1-flash-image-preview）', type: 'image', use: 'image' },
  ] },
