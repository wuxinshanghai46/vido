...
async function analyzeSceneViews(options = {}) {
  ...
  const request = {
    ...
    userPrompt: 'Requested scene constraints: ' + JSON.stringify(requested) + '\n'
      ...
      + 'All supplied scene-asset views must contain zero visible humans. Any person, face, head, hair, body, hand, silhouette, mannequin or human reflection in any view is a NEGATIVE_VIOLATION and must make requirement_qa.pass and overall pass false, even when the location would normally contain staff or visitors. '
