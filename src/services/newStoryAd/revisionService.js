...
function invalidateOutputs(storage, taskId, scope = 'none', options = {}) {
  ...
  const graph = {
    ...
    scene: ['production_graph_v1', 'scene_config', 'scene_assets', 'blueprint_draft_checkpoint', 'blueprint', 'story_flow_sketches', 'story_flow_sketch_batch', 'storyboard_table', 'storyboard_images', 'storyboard_image_batch', 'storyboard_sketches', 'storyboard_sketch_batch', 'keyframe_contracts', 'keyframes', 'tts_audio', 'video_clips', 'final_video'],
    person: ['production_graph_v1', 'blueprint_draft_checkpoint', 'blueprint', 'story_flow_sketches', 'story_flow_sketch_batch', 'storyboard_table', 'storyboard_meta', 'storyboard_images', 'storyboard_image_batch', 'storyboard_sketches', 'storyboard_sketch_batch', 'keyframe_contracts', 'keyframes', 'quality_review', 'tts_audio', 'video_clips', 'video_scene_blocks', 'final_video'],
    ...
    creative: ['production_graph_v1', 'blueprint_draft_checkpoint', 'blueprint', 'story_flow_sketches', 'story_flow_sketch_batch', 'storyboard_table', 'storyboard_meta', 'storyboard_images', 'storyboard_image_batch', 'storyboard_sketches', 'storyboard_sketch_batch', 'keyframe_contracts', 'keyframes', 'quality_review', 'tts_audio', 'video_clips', 'video_scene_blocks', 'final_video'],
    blueprint: ['production_graph_v1', 'story_flow_sketches', 'story_flow_sketch_batch', 'storyboard_table', 'storyboard_meta', 'storyboard_images', 'storyboard_image_batch', 'storyboard_sketches', 'storyboard_sketch_batch', 'keyframe_contracts', 'keyframes', 'quality_review', 'tts_audio', 'video_clips', 'video_scene_blocks', 'final_video'],
    storyboard: ['production_graph_v1', 'storyboard_images', 'storyboard_image_batch', 'storyboard_sketches', 'storyboard_sketch_batch', 'keyframe_contracts', 'keyframes', 'quality_review', 'tts_audio', 'video_clips', 'video_scene_blocks', 'final_video'],
