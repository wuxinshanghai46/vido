...
function invalidateOutputs(storage, taskId, scope = 'none', options = {}) {
  ...
  const graph = {
    source: ['production_graph_v1', 'asset_plan', 'scene_config', 'scene_assets', 'blueprint_draft_checkpoint', 'blueprint', 'story_flow_contract', 'story_flow_sketches', 'story_flow_sketch_batch', 'storyboard_table', 'storyboard_meta', 'storyboard_images', 'storyboard_image_batch', 'storyboard_sketches', 'storyboard_sketch_batch', 'keyframe_contracts', 'keyframes', 'quality_review', 'scene_sound_profiles', 'sound_assets', 'audio_timeline', 'audio_license_ledger', 'tts_audio', 'video_clips', 'video_scene_blocks', 'final_video'],
    product: ['production_graph_v1', 'scene_config', 'scene_assets', 'blueprint_draft_checkpoint', 'blueprint', 'story_flow_sketches', 'story_flow_sketch_batch', 'storyboard_table', 'storyboard_meta', 'storyboard_images', 'storyboard_image_batch', 'storyboard_sketches', 'storyboard_sketch_batch', 'keyframe_contracts', 'keyframes', 'quality_review', 'tts_audio', 'video_clips', 'video_scene_blocks', 'final_video'],
    scene: ['production_graph_v1', 'scene_config', 'scene_assets', 'blueprint_draft_checkpoint', 'blueprint', 'story_flow_contract', 'story_flow_sketches', 'story_flow_sketch_batch', 'storyboard_table', 'storyboard_images', 'storyboard_image_batch', 'storyboard_sketches', 'storyboard_sketch_batch', 'keyframe_contracts', 'keyframes', 'scene_sound_profiles', 'audio_timeline', 'tts_audio', 'video_clips', 'final_video'],
    person: ['production_graph_v1', 'blueprint_draft_checkpoint', 'blueprint', 'story_flow_contract', 'story_flow_sketches', 'story_flow_sketch_batch', 'storyboard_table', 'storyboard_meta', 'storyboard_images', 'storyboard_image_batch', 'storyboard_sketches', 'storyboard_sketch_batch', 'keyframe_contracts', 'keyframes', 'quality_review', 'tts_audio', 'video_clips', 'video_scene_blocks', 'final_video'],
    ...
    person_visual: ['production_graph_v1', 'storyboard_images', 'storyboard_image_batch', 'storyboard_sketches', 'storyboard_sketch_batch', 'keyframe_contracts', 'keyframes', 'quality_review', 'video_clips', 'video_scene_blocks', 'final_video'],
    creative: ['production_graph_v1', 'blueprint_draft_checkpoint', 'blueprint', 'story_flow_contract', 'story_flow_sketches', 'story_flow_sketch_batch', 'storyboard_table', 'storyboard_meta', 'storyboard_images', 'storyboard_image_batch', 'storyboard_sketches', 'storyboard_sketch_batch', 'keyframe_contracts', 'keyframes', 'quality_review', 'tts_audio', 'video_clips', 'video_scene_blocks', 'final_video'],
    blueprint: ['production_graph_v1', 'story_flow_contract', 'story_flow_sketches', 'story_flow_sketch_batch', 'storyboard_table', 'storyboard_meta', 'storyboard_images', 'storyboard_image_batch', 'storyboard_sketches', 'storyboard_sketch_batch', 'keyframe_contracts', 'keyframes', 'quality_review', 'tts_audio', 'video_clips', 'video_scene_blocks', 'final_video'],
    storyboard: ['production_graph_v1', 'storyboard_images', 'storyboard_image_batch', 'storyboard_sketches', 'storyboard_sketch_batch', 'keyframe_contracts', 'keyframes', 'quality_review', 'scene_sound_profiles', 'audio_timeline', 'tts_audio', 'video_clips', 'video_scene_blocks', 'final_video'],
