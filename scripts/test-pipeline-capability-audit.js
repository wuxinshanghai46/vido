...
function main() {
  ...
  assert.strictEqual(report.summary.stage_count, 54);
  ...
  console.log(`pipeline capability audit tests passed: ${report.summary.referenced_stage_count}/54 stages statically referenced`);
}
