...
function main() {
  ...
  assert.strictEqual(report.summary.stage_count, 55);
  ...
  console.log(`pipeline capability audit tests passed: ${report.summary.referenced_stage_count}/55 stages statically referenced`);
}
