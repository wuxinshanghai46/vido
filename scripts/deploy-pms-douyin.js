...
const FILES = [
  'src/services/pipelineModelService.js',  // 加 STAGE_DEFAULTS + listDefaults export
  'src/routes/admin.js',                   // pipeline-models 接口加 defaults 返回
  'public/js/admin.js',                    // 弹窗用 defaults 预填
  'src/services/browserService.js',        // 抖音 loginUrl + afterNav 强化（evaluate 找登录按钮）
];
