...
assert(html.includes('bootstrap.js?v=20260728-story-step-v50'), 'the page shell must bust cached compose UI assets after deployment');
...
assert(bootstrap.includes("const SCRIPT_VERSION = '20260728-story-step-v50'"), 'lazy-loaded story-ad modules must use the same cache-busting version');
