...
assert(html.includes('bootstrap.js?v=20260729-reference-video-person-dossier-v56'), 'the page shell must bust cached compose UI assets after deployment');
...
assert(bootstrap.includes("const SCRIPT_VERSION = '20260729-reference-video-person-dossier-v56'"), 'lazy-loaded story-ad modules must use the same cache-busting version');
