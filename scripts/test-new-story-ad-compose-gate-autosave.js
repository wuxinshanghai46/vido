...
assert(html.includes('bootstrap.js?v=20260730-assist-isolation-v4'), 'the page shell must bust cached compose UI assets after deployment');
...
assert(bootstrap.includes("const SCRIPT_VERSION = '20260730-assist-isolation-v4'"), 'lazy-loaded story-ad modules must use the same cache-busting version');
