...
assert(sceneProduction.includes('data-enter-scene-world='), 'the dedicated scene step must own the modal scene-world entry');
assert(!sceneWorldPage.includes('scene-advanced-details'), 'the obsolete inline scene-world workspace must not remain below scene cards');
