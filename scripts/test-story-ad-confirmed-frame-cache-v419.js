...
async function main() {
  ...
  const ui = { emptyState: x => JSON.stringify(x), escapeHtml: String, mediaPreview: () => '', bindMoreMedia: () => {}, moreMediaButton: () => '', loadGenerationModelPicker: async () => ({ html: '' }), bindGenerationModelPicker: () => () => '' };
