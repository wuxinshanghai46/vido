// 商品数字人改两阶段融合（Topview 模式）
// - 后端 router.post('/images/generate') 商品分支：阶段A 生成人物 → 阶段B 调 _generateProductIntegratedAvatarImage 融合
// - 前端传 product.scene 给后端
// - 前端 toast 提示两阶段耗时 60-90 秒
const fs = require('fs');
