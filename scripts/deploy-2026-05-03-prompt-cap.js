// 修复 nano-banana 2500 字符 prompt 限制（{code:1201}）
// - _generateViaDeyunaiNanoBanana 入口加 prompt 长度 hard cap
// - _generateProductIntegratedAvatarImage prompt 重写紧凑版（1800 字符内，留 500 余量）
const fs = require('fs');
