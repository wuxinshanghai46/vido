...
assert.equal(labels.generationModelDisplayName({ public_name: 'Image-2' }), 'Image-2');
assert.equal(labels.generationModelOptionLabel({ public_name: 'Image-2', provider_code: 'SZ' }), 'Image-2 · SZ');
