...
const files = [
  ...
  'scripts/retry-new-story-ad-storyboard.js',
];
const stamp = new Date().toISOString().replace(/[-:TZ.]/g, '').slice(0, 14);
const backupDir = `/opt/vido/backups/new-story-ad-storyboard-recovery-${stamp}`;
