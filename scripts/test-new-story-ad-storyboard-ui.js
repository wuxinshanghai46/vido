...
assert(html.includes('/js/new-story-ad/bootstrap.js?v=20260730-dossier-performance-v3'), '剧情广告入口必须使用统一导演工作台缓存版本');
assert(fs.readFileSync(path.join(root, 'public/js/new-story-ad/bootstrap.js'), 'utf8').includes("const SCRIPT_VERSION = '20260730-dossier-performance-v3'"), '懒加载的剧情广告子模块必须使用同一缓存版本');
