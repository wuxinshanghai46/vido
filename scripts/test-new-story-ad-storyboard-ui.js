...
assert(html.includes('/js/new-story-ad/bootstrap.js?v=20260724-subject-assets-v5'), '剧情广告入口必须使用统一弹窗缓存版本');
assert(fs.readFileSync(path.join(root, 'public/js/new-story-ad/bootstrap.js'), 'utf8').includes("const SCRIPT_VERSION = '20260724-subject-assets-v5'"), '懒加载的剧情广告子模块必须使用同一缓存版本');
