...
function main() {
  ...
  assert(html.indexOf('bootstrap.js?v=20260721-keyframe-billing-guard-v3') < html.indexOf('digital-human.js?v=20260720-refresh-route-restore-v19'));
  ...
  assert(bootstrap.includes('20260721-keyframe-billing-guard-v3'));
