...
function main() {
  ...
  assert(html.indexOf('bootstrap.js?v=20260721-unified-dialog-v4') < html.indexOf('digital-human.js?v=20260721-unified-dialog-v20'));
  ...
  assert(bootstrap.includes('20260721-unified-dialog-v4'));
