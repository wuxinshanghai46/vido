...
async function main() {
  ...
  assert(html.indexOf('bootstrap.js?v=20260729-reference-ux-v63') < html.indexOf('digital-human.js?v=20260728-disable-legacy-entry-v53'));
  ...
  assert(bootstrap.includes('20260729-reference-ux-v63'));
