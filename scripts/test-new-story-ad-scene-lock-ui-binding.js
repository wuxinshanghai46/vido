...
async function main() {
  ...
  assert(html.includes('bootstrap.js?v=20260727-scene-edit-authority-v32'));
  assert(html.includes('digital-human-wizard.css?v=20260727-scene-edit-authority-v32'));
  assert(html.indexOf('bootstrap.js?v=20260727-scene-edit-authority-v32') < html.indexOf('digital-human.js?v=20260721-unified-dialog-v20'));
  ...
  assert(bootstrap.includes('20260727-scene-edit-authority-v32'));
