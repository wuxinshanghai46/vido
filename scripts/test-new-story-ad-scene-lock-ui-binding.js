...
function main() {
  ...
  assert(html.includes('bootstrap.js?v=20260720-refresh-route-restore-v24'));
  assert(html.indexOf('bootstrap.js?v=20260720-refresh-route-restore-v24') < html.indexOf('digital-human.js?v=20260720-refresh-route-restore-v19'));
  ...
  assert(bootstrap.includes('20260720-refresh-route-restore-v24'));
