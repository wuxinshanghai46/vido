...
async function main() {
  ...
  assert(html.includes('bootstrap.js?v=20260728-story-setup-top-v37'));
  assert(html.includes('digital-human-wizard.css?v=20260728-story-setup-top-v37'));
  assert(html.indexOf('bootstrap.js?v=20260728-story-setup-top-v37') < html.indexOf('digital-human.js?v=20260721-unified-dialog-v20'));
  ...
  assert(bootstrap.includes('20260728-story-setup-top-v37'));
