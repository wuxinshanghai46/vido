...
async function main() {
  ...
  assert(html.indexOf('bootstrap.js?v=20260731-reference-grounding-v2') < html.indexOf('digital-human.js?v=20260728-disable-legacy-entry-v53'));
  ...
  assert(bootstrap.includes('20260731-reference-grounding-v2'));
  assert(html.includes('AI 补齐空间文字（不生成图片）'));
  assert(html.includes('生成当前场景图片（调用图片模型）'));
