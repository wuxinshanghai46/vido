...
function main() {
  ...
  assert(html.includes('bootstrap.js?v=20260721-contract-freshness-v2'));
  assert(html.includes('digital-human-wizard.css?v=20260720-blueprint-lifecycle-v26'));
  assert(html.indexOf('bootstrap.js?v=20260721-contract-freshness-v2') < html.indexOf('digital-human.js?v=20260720-refresh-route-restore-v19'));
  ...
  assert(bootstrap.includes('20260721-contract-freshness-v2'));
