...
function main() {
  ...
  assert(html.includes('bootstrap.js?v=20260725-subject-asset-mode-v9'));
  assert(html.includes('digital-human-wizard.css?v=20260725-subject-asset-mode-v9'));
  assert(html.indexOf('bootstrap.js?v=20260725-subject-asset-mode-v9') < html.indexOf('digital-human.js?v=20260721-unified-dialog-v20'));
  ...
  assert(bootstrap.includes('20260725-subject-asset-mode-v9'));
