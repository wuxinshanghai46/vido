...
async function main() {
  ...
  assert(html.includes('bootstrap.js?v=20260731-person-detail-v1'));
  assert(html.includes('digital-human-wizard.css?v=20260730-dossier-performance-v64'));
  assert(html.indexOf('bootstrap.js?v=20260731-person-detail-v1') < html.indexOf('digital-human.js?v=20260728-disable-legacy-entry-v53'));
  ...
  assert(bootstrap.includes('20260731-person-detail-v1'));
