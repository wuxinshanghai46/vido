...
async function main() {
  ...
  assert(html.includes('bootstrap.js?v=20260728-story-step-v42'));
  assert(html.includes('digital-human-wizard.css?v=20260728-story-step-v42'));
  assert(html.indexOf('bootstrap.js?v=20260728-story-step-v42') < html.indexOf('digital-human.js?v=20260728-story-step-v21'));
  ...
  assert(bootstrap.includes('20260728-story-step-v42'));
