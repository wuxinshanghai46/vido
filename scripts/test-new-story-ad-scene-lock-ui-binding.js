...
function main() {
  ...
  assert(html.includes('bootstrap.js?v=20260720-refresh-route-restore-v21'));
  assert(html.indexOf('bootstrap.js?v=20260720-refresh-route-restore-v21') < html.indexOf('digital-human.js?v=20260720-refresh-route-restore-v19'));
  assert(html.includes('data-nsa-lazy-loader="true"'));
  assert(html.includes('data-nsa-story-ready="1"'));
  ...
  assert(bootstrap.includes('20260720-refresh-route-restore-v21'));
