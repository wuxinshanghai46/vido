...
async function main() {
  ...
  assert(html.includes('digital-human-wizard.css?v=20260729-reference-ux-v63'));
  assert(html.indexOf('bootstrap.js?v=20260730-director-workspace-v1') < html.indexOf('digital-human.js?v=20260728-disable-legacy-entry-v53'));
  ...
  assert(bootstrap.includes('20260730-director-workspace-v1'));
