...
function main() {
  ...
  assert(html.includes('bootstrap.js?v=20260723-story-ad-age-lock-v1'));
  assert(html.includes('digital-human-wizard.css?v=20260723-story-ad-v2-release2'));
  assert(html.indexOf('bootstrap.js?v=20260723-story-ad-age-lock-v1') < html.indexOf('digital-human.js?v=20260721-unified-dialog-v20'));
  ...
  assert(bootstrap.includes('20260723-story-ad-age-lock-v1'));
