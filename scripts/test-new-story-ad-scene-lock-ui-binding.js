...
async function main() {
  ...
  assert(html.includes('bootstrap.js?v=20260729-reference-video-modal-liblib-v59'));
  assert(html.includes('digital-human-wizard.css?v=20260729-reference-video-modal-liblib-v59'));
  assert(html.indexOf('bootstrap.js?v=20260729-reference-video-modal-liblib-v59') < html.indexOf('digital-human.js?v=20260728-disable-legacy-entry-v53'));
  ...
  assert(bootstrap.includes('20260729-reference-video-modal-liblib-v59'));
