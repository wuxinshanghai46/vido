...
async function main() {
  ...
  assert(html.includes('digital-human-wizard.css?v=20260728-full-pipeline-stop-v54'));
  assert(html.indexOf('bootstrap.js?v=20260728-full-pipeline-stop-v54') < html.indexOf('digital-human.js?v=20260728-disable-legacy-entry-v53'));
  ...
  assert(bootstrap.includes('20260728-full-pipeline-stop-v54'));
