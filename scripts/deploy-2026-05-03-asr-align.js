// ASR 强制对齐字幕：抽视频 audio → OpenAI Whisper → 真实时间戳 segments
// - effectsService.js 加 _asrAlignSubtitles + applyEffects 入口 asrAlign 选项
// - avatar.js _applyAvatarPostEffects 默认开启 asrAlign
const fs = require('fs');
