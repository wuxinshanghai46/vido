...
const DOMAIN_RULES = [
  {
    ...
    patterns: [
      ...
      /^scripts\/(?:test-story-ad-(?:final-media-flow|timeline-render)-v341|test-story-ad-sound-confirmation-flow-v345|test-new-story-ad-keyframe-submission|test-story-ad-workflow-scene-sound-v197)\.js$/i,
    ],
  },
  {
