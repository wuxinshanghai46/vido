...
console.log(JSON.stringify({ passed: true, explicit_paid_confirmation: true, hard_budget_cap_rmb: 10, one_candidate_per_text_stage: true, no_media_calls: true, unknown_actual_charge_not_fabricated: true }));
