    ...
    return {
      text: JSON.stringify({
        cast_profiles: [{
          ...
          age_range: '30岁',
          ethnicity: '东亚外貌设计',
          appearanceText: '30岁东亚女性，鹅蛋脸与清晰下颌线，眉眼自然舒展，鼻唇比例真实；身形修长匀称、肩背挺直；暖调肤色保留细微纹理，目光专注，神态可信从容。',
          wardrobeText: '米色羊毛风衣搭配白色棉质衬衫和深灰色直筒长裤，黑色低跟皮鞋；深棕色皮革通勤包与银色简约腕表固定佩戴，配色克制统一，所有材质纹理清晰可信且跨视图保持一致。',
          hairMakeupText: '深棕色长发束成低马尾，侧分刘海保持固定；自然底妆保留肤质，眉形利落、裸色唇妆；不佩戴眼镜，固定佩戴小号银色耳钉。',
          performanceText: '自然走近并确认门锁状态',
          continuityText: '发型、服装和随身包全程一致',
          negativeText: '禁止改变年龄、脸型和五官比例；禁止变换发型发色、妆容和耳饰；禁止增减服装、鞋履、通勤包或改变配色；禁止网红脸、塑料皮肤、过度磨皮、畸形肢体和多余人物。',
        }],
        prop_plan: [{
          id: 'key_card',
          name: '门禁卡',
