...
(async () => {
  ...
  console.log(JSON.stringify({ passed: true, checks: 27, visible_steps: 6, semantic_model_calls: modelCalls, image_calls_before_binding: 0, upstream_unchanged: true, cache_accumulates_sections: true, cache_invalidates_on_revision: true, old_user_flow_route: 410, migration_writes: 0 }));
