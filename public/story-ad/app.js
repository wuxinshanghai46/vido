import { createProjectStore } from './store/projectStore.js?v=20260823-person-plan-assets-v181';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260823-person-plan-assets-v181';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260823-person-plan-assets-v181';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260823-person-plan-assets-v181'),
  assets: () => import('./views/assetCenterView.js?v=20260823-person-plan-assets-v181'),
  scene: () => import('./views/sceneWorldPage.js?v=20260823-person-plan-assets-v181'),
  plot: () => import('./views/plotRoomView.js?v=20260823-person-plan-assets-v181'),
  storyboard: () => import('./views/storyboardView.js?v=20260823-person-plan-assets-v181'),
  final: () => import('./views/finalView.js?v=20260823-person-plan-assets-v181'),
  workflow: () => import('./views/workflowView.js?v=20260823-person-plan-assets-v181'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260823-person-plan-assets-v181');
