import { createProjectStore } from './store/projectStore.js?v=20260827-production-v235b';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260827-production-v235b';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260827-production-v235b';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260827-production-v235b'),
  assets: () => import('./views/assetCenterView.js?v=20260827-production-v235b'),
  scene: () => import('./views/sceneWorldPage.js?v=20260827-production-v235b'),
  plot: () => import('./views/plotRoomView.js?v=20260827-production-v235b'),
  storyboard: () => import('./views/storyboardView.js?v=20260827-production-v235b'),
  final: () => import('./views/finalView.js?v=20260827-production-v235b'),
  workflow: () => import('./views/workflowView.js?v=20260827-production-v235b'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260827-production-v235b');
