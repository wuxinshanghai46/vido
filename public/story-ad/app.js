import { createProjectStore } from './store/projectStore.js?v=20260904-production-v434';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260904-production-v434';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260904-production-v434';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260904-production-v434'),
  assets: () => import('./views/assetCenterView.js?v=20260904-production-v434'),
  scene: () => import('./views/sceneWorldPage.js?v=20260904-production-v434'),
  plot: () => import('./views/plotRoomView.js?v=20260904-production-v434'),
  storyboard: () => import('./views/storyboardView.js?v=20260904-production-v434'),
  sound: () => import('./views/finalSoundView.js?v=20260904-production-v434'),
  compose: () => import('./views/finalView.js?v=20260904-production-v434'),
  edit: () => import('./views/finalEditView.js?v=20260904-production-v434'),
  workflow: () => import('./views/workflowView.js?v=20260904-production-v434'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260904-production-v434');
