import { createProjectStore } from './store/projectStore.js?v=20260829-production-v264';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260829-production-v264';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260829-production-v264';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260829-production-v264'),
  assets: () => import('./views/assetCenterView.js?v=20260829-production-v264'),
  scene: () => import('./views/sceneWorldPage.js?v=20260829-production-v264'),
  plot: () => import('./views/plotRoomView.js?v=20260829-production-v264'),
  storyboard: () => import('./views/storyboardView.js?v=20260829-production-v264'),
  final: () => import('./views/finalView.js?v=20260829-production-v264'),
  workflow: () => import('./views/workflowView.js?v=20260829-production-v264'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260829-production-v264');
