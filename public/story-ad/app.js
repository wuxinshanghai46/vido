import { createProjectStore } from './store/projectStore.js?v=20260904-production-v431';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260904-production-v431';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260904-production-v431';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260904-production-v431'),
  assets: () => import('./views/assetCenterView.js?v=20260904-production-v431'),
  scene: () => import('./views/sceneWorldPage.js?v=20260904-production-v431'),
  plot: () => import('./views/plotRoomView.js?v=20260904-production-v431'),
  storyboard: () => import('./views/storyboardView.js?v=20260904-production-v431'),
  sound: () => import('./views/finalSoundView.js?v=20260904-production-v431'),
  compose: () => import('./views/finalView.js?v=20260904-production-v431'),
  edit: () => import('./views/finalEditView.js?v=20260904-production-v431'),
  workflow: () => import('./views/workflowView.js?v=20260904-production-v431'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260904-production-v431');
