import { createProjectStore } from './store/projectStore.js?v=20260821-dialogue-interaction-v107';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260821-dialogue-interaction-v107';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260821-dialogue-interaction-v107';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260821-dialogue-interaction-v107'),
  assets: () => import('./views/assetCenterView.js?v=20260821-dialogue-interaction-v107'),
  scene: () => import('./views/sceneWorldPage.js?v=20260821-dialogue-interaction-v107'),
  plot: () => import('./views/plotRoomView.js?v=20260821-dialogue-interaction-v107'),
  storyboard: () => import('./views/storyboardView.js?v=20260821-dialogue-interaction-v107'),
  final: () => import('./views/finalView.js?v=20260821-dialogue-interaction-v107'),
  workflow: () => import('./views/workflowView.js?v=20260821-dialogue-interaction-v107'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260821-dialogue-interaction-v107');
