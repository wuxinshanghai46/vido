import { createProjectStore } from './store/projectStore.js?v=20260823-voice-outfit-library-v192';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260823-voice-outfit-library-v192';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260823-voice-outfit-library-v192';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260823-voice-outfit-library-v192'),
  assets: () => import('./views/assetCenterView.js?v=20260823-voice-outfit-library-v192'),
  scene: () => import('./views/sceneWorldPage.js?v=20260823-voice-outfit-library-v192'),
  plot: () => import('./views/plotRoomView.js?v=20260823-voice-outfit-library-v192'),
  storyboard: () => import('./views/storyboardView.js?v=20260823-voice-outfit-library-v192'),
  final: () => import('./views/finalView.js?v=20260823-voice-outfit-library-v192'),
  workflow: () => import('./views/workflowView.js?v=20260823-voice-outfit-library-v192'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260823-voice-outfit-library-v192');
