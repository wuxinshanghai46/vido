import { createProjectStore } from './store/projectStore.js?v=20260821-domain-reference-dashboard-v128';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260821-domain-reference-dashboard-v128';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260821-domain-reference-dashboard-v128';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260821-domain-reference-dashboard-v128'),
  assets: () => import('./views/assetCenterView.js?v=20260821-domain-reference-dashboard-v128'),
  scene: () => import('./views/sceneWorldPage.js?v=20260821-domain-reference-dashboard-v128'),
  plot: () => import('./views/plotRoomView.js?v=20260821-domain-reference-dashboard-v128'),
  storyboard: () => import('./views/storyboardView.js?v=20260821-domain-reference-dashboard-v128'),
  final: () => import('./views/finalView.js?v=20260821-domain-reference-dashboard-v128'),
  workflow: () => import('./views/workflowView.js?v=20260821-domain-reference-dashboard-v128'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260821-domain-reference-dashboard-v128');
