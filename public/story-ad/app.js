import { createProjectStore } from './store/projectStore.js?v=20260904-production-v459';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260904-production-v459';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260904-production-v459';
...
const editorTool = new URLSearchParams(location.search).get('tool') === 'editor'
  ? await import('./views/editorToolCenter.js?v=20260904-production-v459') : null;
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260904-production-v459'),
  assets: () => import('./views/assetCenterView.js?v=20260904-production-v459'),
  scene: () => import('./views/sceneWorldPage.js?v=20260904-production-v459'),
  plot: () => import('./views/plotRoomView.js?v=20260904-production-v459'),
  storyboard: () => import('./views/storyboardView.js?v=20260904-production-v459'),
  compose: () => import('./views/finalView.js?v=20260904-production-v459'),
  workflow: () => import('./views/workflowView.js?v=20260904-production-v459'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260904-production-v459');
