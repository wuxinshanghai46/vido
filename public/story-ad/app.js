import { createProjectStore } from './store/projectStore.js?v=20260824-production-v201w';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260824-production-v201w';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260824-production-v201w';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260824-production-v201w'),
  assets: () => import('./views/assetCenterView.js?v=20260824-production-v201w'),
  scene: () => import('./views/sceneWorldPage.js?v=20260824-production-v201w'),
  plot: () => import('./views/plotRoomView.js?v=20260824-production-v201w'),
  storyboard: () => import('./views/storyboardView.js?v=20260824-production-v201w'),
  final: () => import('./views/finalView.js?v=20260824-production-v201w'),
  workflow: () => import('./views/workflowView.js?v=20260824-production-v201w'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260824-production-v201w');
