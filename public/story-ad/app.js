import { createProjectStore } from './store/projectStore.js?v=20260831-production-v334';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260831-production-v334';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260831-production-v334';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260831-production-v334'),
  assets: () => import('./views/assetCenterView.js?v=20260831-production-v334'),
  scene: () => import('./views/sceneWorldPage.js?v=20260831-production-v334'),
  plot: () => import('./views/plotRoomView.js?v=20260831-production-v334'),
  storyboard: () => import('./views/storyboardView.js?v=20260831-production-v334'),
  final: () => import('./views/finalView.js?v=20260831-production-v334'),
  workflow: () => import('./views/workflowView.js?v=20260831-production-v334'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260831-production-v334');
