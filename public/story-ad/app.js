import { createProjectStore } from './store/projectStore.js?v=20260902-production-v402';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260902-production-v402';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260902-production-v402';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260902-production-v402'),
  assets: () => import('./views/assetCenterView.js?v=20260902-production-v402'),
  scene: () => import('./views/sceneWorldPage.js?v=20260902-production-v402'),
  plot: () => import('./views/plotRoomView.js?v=20260902-production-v402'),
  storyboard: () => import('./views/storyboardView.js?v=20260902-production-v402'),
  sound: () => import('./views/finalSoundView.js?v=20260902-production-v402'),
  compose: () => import('./views/finalView.js?v=20260902-production-v402'),
  edit: () => import('./views/finalEditView.js?v=20260902-production-v402'),
  workflow: () => import('./views/workflowView.js?v=20260902-production-v402'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260902-production-v402');
