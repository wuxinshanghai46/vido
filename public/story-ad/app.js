import { createProjectStore } from './store/projectStore.js?v=20260814-sr13-v21';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260814-sr13-v21';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260814-sr13-v21';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260814-sr13-v21'),
  assets: () => import('./views/assetCenterView.js?v=20260814-sr13-v21'),
  scene: () => import('./views/sceneWorldPage.js?v=20260814-sr13-v21'),
  plot: () => import('./views/plotRoomView.js?v=20260814-sr13-v21'),
  storyboard: () => import('./views/storyboardView.js?v=20260814-sr13-v21'),
  final: () => import('./views/finalView.js?v=20260814-sr13-v21'),
  workflow: () => import('./views/workflowView.js?v=20260814-sr13-v21'),
};
