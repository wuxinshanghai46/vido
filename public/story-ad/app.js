import { createProjectStore } from './store/projectStore.js?v=20260823-character-library-v185';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260823-character-library-v185';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260823-character-library-v185';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260823-character-library-v185'),
  assets: () => import('./views/assetCenterView.js?v=20260823-character-library-v185'),
  scene: () => import('./views/sceneWorldPage.js?v=20260823-character-library-v185'),
  plot: () => import('./views/plotRoomView.js?v=20260823-character-library-v185'),
  storyboard: () => import('./views/storyboardView.js?v=20260823-character-library-v185'),
  final: () => import('./views/finalView.js?v=20260823-character-library-v185'),
  workflow: () => import('./views/workflowView.js?v=20260823-character-library-v185'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260823-character-library-v185');
