import { createProjectStore } from './store/projectStore.js?v=20260804-reference-sync-idempotency-v16';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260804-reference-sync-idempotency-v16';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260804-reference-sync-idempotency-v16';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260804-reference-sync-idempotency-v16'),
  assets: () => import('./views/assetCenterView.js?v=20260804-reference-sync-idempotency-v16'),
  plot: () => import('./views/plotRoomView.js?v=20260804-reference-sync-idempotency-v16'),
  storyboard: () => import('./views/storyboardView.js?v=20260804-reference-sync-idempotency-v16'),
  shot: () => import('./views/shotDesignerView.js?v=20260804-reference-sync-idempotency-v16'),
  final: () => import('./views/finalView.js?v=20260804-reference-sync-idempotency-v16'),
  workflow: () => import('./views/workflowView.js?v=20260804-reference-sync-idempotency-v16'),
};
