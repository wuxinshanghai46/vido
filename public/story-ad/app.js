import { createProjectStore } from './store/projectStore.js?v=20260824-production-v201ao';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260824-production-v201ao';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260824-production-v201ao';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260824-production-v201ao'),
  assets: () => import('./views/assetCenterView.js?v=20260824-production-v201ao'),
  scene: () => import('./views/sceneWorldPage.js?v=20260824-production-v201ao'),
  plot: () => import('./views/plotRoomView.js?v=20260824-production-v201ao'),
  storyboard: () => import('./views/storyboardView.js?v=20260824-production-v201ao'),
  final: () => import('./views/finalView.js?v=20260824-production-v201ao'),
  workflow: () => import('./views/workflowView.js?v=20260824-production-v201ao'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260824-production-v201ao');
