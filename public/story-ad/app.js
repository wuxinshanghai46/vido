...
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260820-dialogue-flow-v85';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260820-dialogue-flow-v85';
import { confirmDialog } from './components/dialog.js?v=20260820-dialogue-flow-v85';
import { applyHistoricalReadonlyControls, historicalStepReadOnly, historicalStepUsesGlobalEdit } from './workspaceHistoryMode.js?v=20260820-dialogue-flow-v85';
...
const VIEW_MODULES = {
  ...
  assets: () => import('./views/assetCenterView.js?v=20260820-dialogue-flow-v85'),
  ...
  final: () => import('./views/finalView.js?v=20260820-dialogue-flow-v85'),
  workflow: () => import('./views/workflowView.js?v=20260820-dialogue-flow-v85'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260820-dialogue-flow-v85');
