import { createProjectStore } from './store/projectStore.js?v=20260830-production-v289g';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260830-production-v289g';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260830-production-v289g';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260830-production-v289g'),
  assets: () => import('./views/assetCenterView.js?v=20260830-production-v289g'),
  scene: () => import('./views/sceneWorldPage.js?v=20260830-production-v289g'),
  plot: () => import('./views/plotRoomView.js?v=20260830-production-v289g'),
  storyboard: () => import('./views/storyboardView.js?v=20260830-production-v289g'),
  final: () => import('./views/finalView.js?v=20260830-production-v289g'),
  workflow: () => import('./views/workflowView.js?v=20260830-production-v289g'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260830-production-v289g');
