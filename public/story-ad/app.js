import { createProjectStore } from './store/projectStore.js?v=20260826-production-v230a';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260826-production-v230a';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260826-production-v230a';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260826-production-v230a'),
  assets: () => import('./views/assetCenterView.js?v=20260826-production-v230a'),
  scene: () => import('./views/sceneWorldPage.js?v=20260826-production-v230a'),
  plot: () => import('./views/plotRoomView.js?v=20260826-production-v230a'),
  storyboard: () => import('./views/storyboardView.js?v=20260826-production-v230a'),
  final: () => import('./views/finalView.js?v=20260826-production-v230a'),
  workflow: () => import('./views/workflowView.js?v=20260826-production-v230a'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260826-production-v230a');
