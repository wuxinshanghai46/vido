import { createProjectStore } from './store/projectStore.js?v=20260813-sr9-v4';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260813-sr9-v4';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260813-sr9-v4';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260813-sr9-v4'),
  assets: () => import('./views/assetCenterView.js?v=20260813-sr9-v4'),
  scene: () => import('./views/sceneWorldPage.js?v=20260813-sr9-v4'),
  plot: () => import('./views/plotRoomView.js?v=20260813-sr9-v4'),
  storyboard: () => import('./views/storyboardView.js?v=20260813-sr9-v4'),
  final: () => import('./views/finalView.js?v=20260813-sr9-v4'),
  workflow: () => import('./views/workflowView.js?v=20260813-sr9-v4'),
};
