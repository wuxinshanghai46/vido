import { createProjectStore } from './store/projectStore.js?v=20260829-production-v257b';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260829-production-v257b';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260829-production-v257b';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260829-production-v257b'),
  assets: () => import('./views/assetCenterView.js?v=20260829-production-v257b'),
  scene: () => import('./views/sceneWorldPage.js?v=20260829-production-v257b'),
  plot: () => import('./views/plotRoomView.js?v=20260829-production-v257b'),
  storyboard: () => import('./views/storyboardView.js?v=20260829-production-v257b'),
  final: () => import('./views/finalView.js?v=20260829-production-v257b'),
  workflow: () => import('./views/workflowView.js?v=20260829-production-v257b'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260829-production-v257b');
