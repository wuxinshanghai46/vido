import { createProjectStore } from './store/projectStore.js?v=20260822-production-board-v160';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260822-production-board-v160';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260822-production-board-v160';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260822-production-board-v160'),
  assets: () => import('./views/assetCenterView.js?v=20260822-production-board-v160'),
  scene: () => import('./views/sceneWorldPage.js?v=20260822-production-board-v160'),
  plot: () => import('./views/plotRoomView.js?v=20260822-production-board-v160'),
  storyboard: () => import('./views/storyboardView.js?v=20260822-production-board-v160'),
  final: () => import('./views/finalView.js?v=20260822-production-board-v160'),
  workflow: () => import('./views/workflowView.js?v=20260822-production-board-v160'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260822-production-board-v160');
