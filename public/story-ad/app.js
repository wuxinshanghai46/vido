...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260823-role-safe-diagnostics-v193'),
  assets: () => import('./views/assetCenterView.js?v=20260823-role-safe-diagnostics-v193'),
  scene: () => import('./views/sceneWorldPage.js?v=20260823-role-safe-diagnostics-v193'),
  plot: () => import('./views/plotRoomView.js?v=20260823-role-safe-diagnostics-v193'),
  storyboard: () => import('./views/storyboardView.js?v=20260823-role-safe-diagnostics-v193'),
  final: () => import('./views/finalView.js?v=20260823-role-safe-diagnostics-v193'),
  workflow: () => import('./views/workflowView.js?v=20260823-role-safe-diagnostics-v193'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260823-role-safe-diagnostics-v193');
