import { createProjectStore } from './store/projectStore.js?v=20260831-production-v320';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260831-production-v320';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260831-production-v320';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260831-production-v320'),
  assets: () => import('./views/assetCenterView.js?v=20260831-production-v320'),
  scene: () => import('./views/sceneWorldPage.js?v=20260831-production-v320'),
  plot: () => import('./views/plotRoomView.js?v=20260831-production-v320'),
  storyboard: () => import('./views/storyboardView.js?v=20260831-production-v320'),
  final: () => import('./views/finalView.js?v=20260831-production-v320'),
  workflow: () => import('./views/workflowView.js?v=20260831-production-v320'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260831-production-v320');
