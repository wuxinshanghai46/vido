import { createProjectStore } from './store/projectStore.js?v=20260826-production-v230h';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260826-production-v230h';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260826-production-v230h';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260826-production-v230h'),
  assets: () => import('./views/assetCenterView.js?v=20260826-production-v230h'),
  scene: () => import('./views/sceneWorldPage.js?v=20260826-production-v230h'),
  plot: () => import('./views/plotRoomView.js?v=20260826-production-v230h'),
  storyboard: () => import('./views/storyboardView.js?v=20260826-production-v230h'),
  final: () => import('./views/finalView.js?v=20260826-production-v230h'),
  workflow: () => import('./views/workflowView.js?v=20260826-production-v230h'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260826-production-v230h');
