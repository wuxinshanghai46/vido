import { createProjectStore } from './store/projectStore.js?v=20260824-production-v201l';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260824-production-v201l';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260824-production-v201l';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260824-production-v201l'),
  assets: () => import('./views/assetCenterView.js?v=20260824-production-v201l'),
  scene: () => import('./views/sceneWorldPage.js?v=20260824-production-v201l'),
  plot: () => import('./views/plotRoomView.js?v=20260824-production-v201l'),
  storyboard: () => import('./views/storyboardView.js?v=20260824-production-v201l'),
  final: () => import('./views/finalView.js?v=20260824-production-v201l'),
  workflow: () => import('./views/workflowView.js?v=20260824-production-v201l'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260824-production-v201l');
