import { createProjectStore } from './store/projectStore.js?v=20260824-production-v201am';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260824-production-v201am';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260824-production-v201am';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260824-production-v201am'),
  assets: () => import('./views/assetCenterView.js?v=20260824-production-v201am'),
  scene: () => import('./views/sceneWorldPage.js?v=20260824-production-v201am'),
  plot: () => import('./views/plotRoomView.js?v=20260824-production-v201am'),
  storyboard: () => import('./views/storyboardView.js?v=20260824-production-v201am'),
  final: () => import('./views/finalView.js?v=20260824-production-v201am'),
  workflow: () => import('./views/workflowView.js?v=20260824-production-v201am'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260824-production-v201am');
