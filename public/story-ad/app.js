import { createProjectStore } from './store/projectStore.js?v=20260826-production-v230n';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260826-production-v230n';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260826-production-v230n';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260826-production-v230n'),
  assets: () => import('./views/assetCenterView.js?v=20260826-production-v230n'),
  scene: () => import('./views/sceneWorldPage.js?v=20260826-production-v230n'),
  plot: () => import('./views/plotRoomView.js?v=20260826-production-v230n'),
  storyboard: () => import('./views/storyboardView.js?v=20260826-production-v230n'),
  final: () => import('./views/finalView.js?v=20260826-production-v230n'),
  workflow: () => import('./views/workflowView.js?v=20260826-production-v230n'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260826-production-v230n');
