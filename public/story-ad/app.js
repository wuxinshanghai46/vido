import { createProjectStore } from './store/projectStore.js?v=20260806-knowledge-runtime-v47';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260806-knowledge-runtime-v47';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260806-knowledge-runtime-v47';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260806-knowledge-runtime-v47'),
  assets: () => import('./views/assetCenterView.js?v=20260806-knowledge-runtime-v47'),
  plot: () => import('./views/plotRoomView.js?v=20260806-knowledge-runtime-v47'),
  storyboard: () => import('./views/storyboardView.js?v=20260806-knowledge-runtime-v47'),
  shot: () => import('./views/shotDesignerView.js?v=20260806-knowledge-runtime-v47'),
  final: () => import('./views/finalView.js?v=20260806-knowledge-runtime-v47'),
  workflow: () => import('./views/workflowView.js?v=20260806-knowledge-runtime-v47'),
};
