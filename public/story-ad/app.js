import { createProjectStore } from './store/projectStore.js?v=20260826-production-v230g';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260826-production-v230g';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260826-production-v230g';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260826-production-v230g'),
  assets: () => import('./views/assetCenterView.js?v=20260826-production-v230g'),
  scene: () => import('./views/sceneWorldPage.js?v=20260826-production-v230g'),
  plot: () => import('./views/plotRoomView.js?v=20260826-production-v230g'),
  storyboard: () => import('./views/storyboardView.js?v=20260826-production-v230g'),
  final: () => import('./views/finalView.js?v=20260826-production-v230g'),
  workflow: () => import('./views/workflowView.js?v=20260826-production-v230g'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260826-production-v230g');
