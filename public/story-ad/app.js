import { createProjectStore } from './store/projectStore.js?v=20260831-production-v336';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260831-production-v336';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260831-production-v336';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260831-production-v336'),
  assets: () => import('./views/assetCenterView.js?v=20260831-production-v336'),
  scene: () => import('./views/sceneWorldPage.js?v=20260831-production-v336'),
  plot: () => import('./views/plotRoomView.js?v=20260831-production-v336'),
  storyboard: () => import('./views/storyboardView.js?v=20260831-production-v336'),
  final: () => import('./views/finalView.js?v=20260831-production-v336'),
  workflow: () => import('./views/workflowView.js?v=20260831-production-v336'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260831-production-v336');
