import { createProjectStore } from './store/projectStore.js?v=20260814-sr9-v10';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260814-sr9-v10';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260814-sr9-v10';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260814-sr9-v10'),
  assets: () => import('./views/assetCenterView.js?v=20260814-sr9-v10'),
  scene: () => import('./views/sceneWorldPage.js?v=20260814-sr9-v10'),
  plot: () => import('./views/plotRoomView.js?v=20260814-sr9-v10'),
  storyboard: () => import('./views/storyboardView.js?v=20260814-sr9-v10'),
  final: () => import('./views/finalView.js?v=20260814-sr9-v10'),
  workflow: () => import('./views/workflowView.js?v=20260814-sr9-v10'),
};
