import { createProjectStore } from './store/projectStore.js?v=20260814-reference-world-recognition-v49';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260814-reference-world-recognition-v49';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260814-reference-world-recognition-v49';
import { confirmDialog } from './components/dialog.js?v=20260814-reference-world-recognition-v49';
import { historicalStepReadOnly } from './workspaceHistoryMode.js?v=20260814-reference-world-recognition-v49';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260814-reference-world-recognition-v49'),
  assets: () => import('./views/assetCenterView.js?v=20260814-reference-world-recognition-v49'),
  scene: () => import('./views/sceneWorldPage.js?v=20260814-reference-world-recognition-v49'),
  plot: () => import('./views/plotRoomView.js?v=20260814-reference-world-recognition-v49'),
  storyboard: () => import('./views/storyboardView.js?v=20260814-reference-world-recognition-v49'),
  final: () => import('./views/finalView.js?v=20260814-reference-world-recognition-v49'),
  workflow: () => import('./views/workflowView.js?v=20260814-reference-world-recognition-v49'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260814-reference-world-recognition-v49');
