import { createProjectStore } from './store/projectStore.js?v=20260830-production-v290c';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260830-production-v290c';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260830-production-v290c';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260830-production-v290c'),
  assets: () => import('./views/assetCenterView.js?v=20260830-production-v290c'),
  scene: () => import('./views/sceneWorldPage.js?v=20260830-production-v290c'),
  plot: () => import('./views/plotRoomView.js?v=20260830-production-v290c'),
  storyboard: () => import('./views/storyboardView.js?v=20260830-production-v290c'),
  final: () => import('./views/finalView.js?v=20260830-production-v290c'),
  workflow: () => import('./views/workflowView.js?v=20260830-production-v290c'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260830-production-v290c');
