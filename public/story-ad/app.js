import { createProjectStore } from './store/projectStore.js?v=20260824-production-v201y';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260824-production-v201y';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260824-production-v201y';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260824-production-v201y'),
  assets: () => import('./views/assetCenterView.js?v=20260824-production-v201y'),
  scene: () => import('./views/sceneWorldPage.js?v=20260824-production-v201y'),
  plot: () => import('./views/plotRoomView.js?v=20260824-production-v201y'),
  storyboard: () => import('./views/storyboardView.js?v=20260824-production-v201y'),
  final: () => import('./views/finalView.js?v=20260824-production-v201y'),
  workflow: () => import('./views/workflowView.js?v=20260824-production-v201y'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260824-production-v201y');
