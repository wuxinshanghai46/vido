import { createProjectStore } from './store/projectStore.js?v=20260822-reference-blueprint-complete-v150';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260822-reference-blueprint-complete-v150';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260822-reference-blueprint-complete-v150';
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260822-reference-blueprint-complete-v150');
