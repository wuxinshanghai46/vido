import { createProjectStore } from './store/projectStore.js?v=20260904-production-v437';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260904-production-v437';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260904-production-v437';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260904-production-v437'),
  assets: () => import('./views/assetCenterView.js?v=20260904-production-v437'),
  scene: () => import('./views/sceneWorldPage.js?v=20260904-production-v437'),
  plot: () => import('./views/plotRoomView.js?v=20260904-production-v437'),
  storyboard: () => import('./views/storyboardView.js?v=20260904-production-v437'),
  sound: () => import('./views/finalSoundView.js?v=20260904-production-v437'),
  compose: () => import('./views/finalView.js?v=20260904-production-v437'),
  edit: () => import('./views/finalEditView.js?v=20260904-production-v437'),
  workflow: () => import('./views/workflowView.js?v=20260904-production-v437'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260904-production-v437');
