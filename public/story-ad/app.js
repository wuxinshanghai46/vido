import { createProjectStore } from './store/projectStore.js?v=20260831-production-v324';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260831-production-v324';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260831-production-v324';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260831-production-v324'),
  assets: () => import('./views/assetCenterView.js?v=20260831-production-v324'),
  scene: () => import('./views/sceneWorldPage.js?v=20260831-production-v324'),
  plot: () => import('./views/plotRoomView.js?v=20260831-production-v324'),
  storyboard: () => import('./views/storyboardView.js?v=20260831-production-v324'),
  final: () => import('./views/finalView.js?v=20260831-production-v324'),
  workflow: () => import('./views/workflowView.js?v=20260831-production-v324'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260831-production-v324');
