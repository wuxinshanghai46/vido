import { createProjectStore } from './store/projectStore.js?v=20260804-reference-editable-brief-fold-v17';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260804-reference-editable-brief-fold-v17';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260804-reference-editable-brief-fold-v17';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260804-reference-editable-brief-fold-v17'),
  assets: () => import('./views/assetCenterView.js?v=20260804-reference-editable-brief-fold-v17'),
  plot: () => import('./views/plotRoomView.js?v=20260804-reference-editable-brief-fold-v17'),
  storyboard: () => import('./views/storyboardView.js?v=20260804-reference-editable-brief-fold-v17'),
  shot: () => import('./views/shotDesignerView.js?v=20260804-reference-editable-brief-fold-v17'),
  final: () => import('./views/finalView.js?v=20260804-reference-editable-brief-fold-v17'),
  workflow: () => import('./views/workflowView.js?v=20260804-reference-editable-brief-fold-v17'),
};
