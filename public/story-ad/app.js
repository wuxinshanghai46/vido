import { createProjectStore } from './store/projectStore.js?v=20260821-dialogue-intake-v116';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260821-dialogue-intake-v116';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260821-dialogue-intake-v116';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260821-dialogue-intake-v116'),
  assets: () => import('./views/assetCenterView.js?v=20260821-dialogue-intake-v116'),
  scene: () => import('./views/sceneWorldPage.js?v=20260821-dialogue-intake-v116'),
  plot: () => import('./views/plotRoomView.js?v=20260821-dialogue-intake-v116'),
  storyboard: () => import('./views/storyboardView.js?v=20260821-dialogue-intake-v116'),
  final: () => import('./views/finalView.js?v=20260821-dialogue-intake-v116'),
  workflow: () => import('./views/workflowView.js?v=20260821-dialogue-intake-v116'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260821-dialogue-intake-v116');
