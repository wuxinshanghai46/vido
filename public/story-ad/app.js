import { createProjectStore } from './store/projectStore.js?v=20260822-reference-failure-recovery-v146';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260822-reference-failure-recovery-v146';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260822-reference-failure-recovery-v146';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260822-reference-failure-recovery-v146'),
  assets: () => import('./views/assetCenterView.js?v=20260822-reference-failure-recovery-v146'),
  scene: () => import('./views/sceneWorldPage.js?v=20260822-reference-failure-recovery-v146'),
  plot: () => import('./views/plotRoomView.js?v=20260822-reference-failure-recovery-v146'),
  storyboard: () => import('./views/storyboardView.js?v=20260822-reference-failure-recovery-v146'),
  final: () => import('./views/finalView.js?v=20260822-reference-failure-recovery-v146'),
  workflow: () => import('./views/workflowView.js?v=20260822-reference-failure-recovery-v146'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260822-reference-failure-recovery-v146');
