import { createProjectStore } from './store/projectStore.js?v=20260829-production-v276d';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260829-production-v276d';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260829-production-v276d';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260829-production-v276d'),
  assets: () => import('./views/assetCenterView.js?v=20260829-production-v276d'),
  scene: () => import('./views/sceneWorldPage.js?v=20260829-production-v276d'),
  plot: () => import('./views/plotRoomView.js?v=20260829-production-v276d'),
  storyboard: () => import('./views/storyboardView.js?v=20260829-production-v276d'),
  final: () => import('./views/finalView.js?v=20260829-production-v276d'),
  workflow: () => import('./views/workflowView.js?v=20260829-production-v276d'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260829-production-v276d');
