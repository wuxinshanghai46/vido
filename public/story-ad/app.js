import { createProjectStore } from './store/projectStore.js?v=20260820-dialogue-flow-v86';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260820-dialogue-flow-v86';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260820-dialogue-flow-v86';
import { confirmDialog } from './components/dialog.js?v=20260820-dialogue-flow-v86';
import { applyHistoricalReadonlyControls, historicalStepReadOnly, historicalStepUsesGlobalEdit } from './workspaceHistoryMode.js?v=20260820-dialogue-flow-v86';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260820-dialogue-flow-v86'),
  assets: () => import('./views/assetCenterView.js?v=20260820-dialogue-flow-v86'),
  scene: () => import('./views/sceneWorldPage.js?v=20260820-dialogue-flow-v86'),
  plot: () => import('./views/plotRoomView.js?v=20260820-dialogue-flow-v86'),
  storyboard: () => import('./views/storyboardView.js?v=20260820-dialogue-flow-v86'),
  final: () => import('./views/finalView.js?v=20260820-dialogue-flow-v86'),
  workflow: () => import('./views/workflowView.js?v=20260820-dialogue-flow-v86'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260820-dialogue-flow-v86');
