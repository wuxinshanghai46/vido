import { createProjectStore } from './store/projectStore.js?v=20260826-production-v231e';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260826-production-v231e';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260826-production-v231e';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260826-production-v231e'),
  assets: () => import('./views/assetCenterView.js?v=20260826-production-v231e'),
  scene: () => import('./views/sceneWorldPage.js?v=20260826-production-v231e'),
  plot: () => import('./views/plotRoomView.js?v=20260826-production-v231e'),
  storyboard: () => import('./views/storyboardView.js?v=20260826-production-v231e'),
  final: () => import('./views/finalView.js?v=20260826-production-v231e'),
  workflow: () => import('./views/workflowView.js?v=20260826-production-v231e'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260826-production-v231e');
