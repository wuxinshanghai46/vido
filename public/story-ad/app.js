import { createProjectStore } from './store/projectStore.js?v=20260904-production-v456';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260904-production-v456';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260904-production-v456';
...
const editorTool = new URLSearchParams(location.search).get('tool') === 'editor'
  ? await import('./views/editorToolCenter.js?v=20260904-production-v456') : null;
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260904-production-v456'),
  assets: () => import('./views/assetCenterView.js?v=20260904-production-v456'),
  scene: () => import('./views/sceneWorldPage.js?v=20260904-production-v456'),
  plot: () => import('./views/plotRoomView.js?v=20260904-production-v456'),
  storyboard: () => import('./views/storyboardView.js?v=20260904-production-v456'),
  compose: () => import('./views/finalView.js?v=20260904-production-v456'),
  workflow: () => import('./views/workflowView.js?v=20260904-production-v456'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260904-production-v456');
