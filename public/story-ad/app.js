import { createProjectStore } from './store/projectStore.js?v=20260813-ui-v234';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260813-ui-v234';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260813-ui-v234';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260813-ui-v234'),
  assets: () => import('./views/assetCenterView.js?v=20260813-ui-v234'),
  scene: () => import('./views/sceneWorldPage.js?v=20260813-ui-v234'),
  plot: () => import('./views/plotRoomView.js?v=20260813-ui-v234'),
  storyboard: () => import('./views/storyboardView.js?v=20260813-ui-v234'),
  final: () => import('./views/finalView.js?v=20260813-ui-v234'),
  workflow: () => import('./views/workflowView.js?v=20260813-ui-v234'),
};
