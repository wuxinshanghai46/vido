import { createProjectStore } from './store/projectStore.js?v=20260826-production-v231d';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260826-production-v231d';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260826-production-v231d';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260826-production-v231d'),
  assets: () => import('./views/assetCenterView.js?v=20260826-production-v231d'),
  scene: () => import('./views/sceneWorldPage.js?v=20260826-production-v231d'),
  plot: () => import('./views/plotRoomView.js?v=20260826-production-v231d'),
  storyboard: () => import('./views/storyboardView.js?v=20260826-production-v231d'),
  final: () => import('./views/finalView.js?v=20260826-production-v231d'),
  workflow: () => import('./views/workflowView.js?v=20260826-production-v231d'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260826-production-v231d');
