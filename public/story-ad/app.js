import { createProjectStore } from './store/projectStore.js?v=20260904-production-v446';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260904-production-v446';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260904-production-v446';
...
const editorTool = new URLSearchParams(location.search).get('tool') === 'editor'
  ? await import('./views/editorToolCenter.js?v=20260904-production-v446') : null;
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260904-production-v446'),
  assets: () => import('./views/assetCenterView.js?v=20260904-production-v446'),
  scene: () => import('./views/sceneWorldPage.js?v=20260904-production-v446'),
  plot: () => import('./views/plotRoomView.js?v=20260904-production-v446'),
  storyboard: () => import('./views/storyboardView.js?v=20260904-production-v446'),
  compose: () => import('./views/finalView.js?v=20260904-production-v446'),
  workflow: () => import('./views/workflowView.js?v=20260904-production-v446'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260904-production-v446');
