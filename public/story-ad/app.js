import { createProjectStore } from './store/projectStore.js?v=20260821-dialogue-interaction-v108';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260821-dialogue-interaction-v108';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260821-dialogue-interaction-v108';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260821-dialogue-interaction-v108'),
  assets: () => import('./views/assetCenterView.js?v=20260821-dialogue-interaction-v108'),
  scene: () => import('./views/sceneWorldPage.js?v=20260821-dialogue-interaction-v108'),
  plot: () => import('./views/plotRoomView.js?v=20260821-dialogue-interaction-v108'),
  storyboard: () => import('./views/storyboardView.js?v=20260821-dialogue-interaction-v108'),
  final: () => import('./views/finalView.js?v=20260821-dialogue-interaction-v108'),
  workflow: () => import('./views/workflowView.js?v=20260821-dialogue-interaction-v108'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260821-dialogue-interaction-v108');
