import { createProjectStore } from './store/projectStore.js?v=20260824-production-v201au';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260824-production-v201au';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260824-production-v201au';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260824-production-v201au'),
  assets: () => import('./views/assetCenterView.js?v=20260824-production-v201au'),
  scene: () => import('./views/sceneWorldPage.js?v=20260824-production-v201au'),
  plot: () => import('./views/plotRoomView.js?v=20260824-production-v201au'),
  storyboard: () => import('./views/storyboardView.js?v=20260824-production-v201au'),
  final: () => import('./views/finalView.js?v=20260824-production-v201au'),
  workflow: () => import('./views/workflowView.js?v=20260824-production-v201au'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260824-production-v201au');
