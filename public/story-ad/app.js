import { createProjectStore } from './store/projectStore.js?v=20260901-production-v367';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260901-production-v367';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260901-production-v367';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260901-production-v367'),
  assets: () => import('./views/assetCenterView.js?v=20260901-production-v367'),
  scene: () => import('./views/sceneWorldPage.js?v=20260901-production-v367'),
  plot: () => import('./views/plotRoomView.js?v=20260901-production-v367'),
  storyboard: () => import('./views/storyboardView.js?v=20260901-production-v367'),
  sound: () => import('./views/finalSoundView.js?v=20260901-production-v367'),
  compose: () => import('./views/finalView.js?v=20260901-production-v367'),
  edit: () => import('./views/finalEditView.js?v=20260901-production-v367'),
  workflow: () => import('./views/workflowView.js?v=20260901-production-v367'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260901-production-v367');
