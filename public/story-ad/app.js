import { createProjectStore } from './store/projectStore.js?v=20260824-production-v201av';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260824-production-v201av';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260824-production-v201av';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260824-production-v201av'),
  assets: () => import('./views/assetCenterView.js?v=20260824-production-v201av'),
  scene: () => import('./views/sceneWorldPage.js?v=20260824-production-v201av'),
  plot: () => import('./views/plotRoomView.js?v=20260824-production-v201av'),
  storyboard: () => import('./views/storyboardView.js?v=20260824-production-v201av'),
  final: () => import('./views/finalView.js?v=20260824-production-v201av'),
  workflow: () => import('./views/workflowView.js?v=20260824-production-v201av'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260824-production-v201av');
