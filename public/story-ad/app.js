import { createProjectStore } from './store/projectStore.js?v=20260821-dialogue-v120';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260821-dialogue-v120';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260821-dialogue-v120';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260821-dialogue-v120'),
  assets: () => import('./views/assetCenterView.js?v=20260821-dialogue-v120'),
  scene: () => import('./views/sceneWorldPage.js?v=20260821-dialogue-v120'),
  plot: () => import('./views/plotRoomView.js?v=20260821-dialogue-v120'),
  storyboard: () => import('./views/storyboardView.js?v=20260821-dialogue-v120'),
  final: () => import('./views/finalView.js?v=20260821-dialogue-v120'),
  workflow: () => import('./views/workflowView.js?v=20260821-dialogue-v120'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260821-dialogue-v120');
