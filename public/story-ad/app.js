import { createProjectStore } from './store/projectStore.js?v=20260824-production-v201aj';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260824-production-v201aj';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260824-production-v201aj';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260824-production-v201aj'),
  assets: () => import('./views/assetCenterView.js?v=20260824-production-v201aj'),
  scene: () => import('./views/sceneWorldPage.js?v=20260824-production-v201aj'),
  plot: () => import('./views/plotRoomView.js?v=20260824-production-v201aj'),
  storyboard: () => import('./views/storyboardView.js?v=20260824-production-v201aj'),
  final: () => import('./views/finalView.js?v=20260824-production-v201aj'),
  workflow: () => import('./views/workflowView.js?v=20260824-production-v201aj'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260824-production-v201aj');
