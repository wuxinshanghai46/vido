import { createProjectStore } from './store/projectStore.js?v=20260821-dialogue-v121';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260821-dialogue-v121';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260821-dialogue-v121';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260821-dialogue-v121'),
  assets: () => import('./views/assetCenterView.js?v=20260821-dialogue-v121'),
  scene: () => import('./views/sceneWorldPage.js?v=20260821-dialogue-v121'),
  plot: () => import('./views/plotRoomView.js?v=20260821-dialogue-v121'),
  storyboard: () => import('./views/storyboardView.js?v=20260821-dialogue-v121'),
  final: () => import('./views/finalView.js?v=20260821-dialogue-v121'),
  workflow: () => import('./views/workflowView.js?v=20260821-dialogue-v121'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260821-dialogue-v121');
