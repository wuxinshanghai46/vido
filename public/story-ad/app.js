import { createProjectStore } from './store/projectStore.js?v=20260810-psave-v140';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260810-psave-v140';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260810-psave-v140';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260810-psave-v140'),
  assets: () => import('./views/assetCenterView.js?v=20260810-psave-v140'),
  plot: () => import('./views/plotRoomView.js?v=20260810-psave-v140'),
  storyboard: () => import('./views/storyboardView.js?v=20260810-psave-v140'),
  shot: () => import('./views/shotDesignerView.js?v=20260810-psave-v140'),
  final: () => import('./views/finalView.js?v=20260810-psave-v140'),
  workflow: () => import('./views/workflowView.js?v=20260810-psave-v140'),
};
