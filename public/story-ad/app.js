import { createProjectStore } from './store/projectStore.js?v=20260824-production-v204f';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260824-production-v204f';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260824-production-v204f';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260824-production-v204f'),
  assets: () => import('./views/assetCenterView.js?v=20260824-production-v204f'),
  scene: () => import('./views/sceneWorldPage.js?v=20260824-production-v204f'),
  plot: () => import('./views/plotRoomView.js?v=20260824-production-v204f'),
  storyboard: () => import('./views/storyboardView.js?v=20260824-production-v204f'),
  final: () => import('./views/finalView.js?v=20260824-production-v204f'),
  workflow: () => import('./views/workflowView.js?v=20260824-production-v204f'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260824-production-v204f');
