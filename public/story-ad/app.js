import { createProjectStore } from './store/projectStore.js?v=20260813-sr9-v6';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260813-sr9-v6';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260813-sr9-v6';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260813-sr9-v6'),
  assets: () => import('./views/assetCenterView.js?v=20260813-sr9-v6'),
  scene: () => import('./views/sceneWorldPage.js?v=20260813-sr9-v6'),
  plot: () => import('./views/plotRoomView.js?v=20260813-sr9-v6'),
  storyboard: () => import('./views/storyboardView.js?v=20260813-sr9-v6'),
  final: () => import('./views/finalView.js?v=20260813-sr9-v6'),
  workflow: () => import('./views/workflowView.js?v=20260813-sr9-v6'),
};
