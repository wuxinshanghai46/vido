import { createProjectStore } from './store/projectStore.js?v=20260824-production-v201x';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260824-production-v201x';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260824-production-v201x';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260824-production-v201x'),
  assets: () => import('./views/assetCenterView.js?v=20260824-production-v201x'),
  scene: () => import('./views/sceneWorldPage.js?v=20260824-production-v201x'),
  plot: () => import('./views/plotRoomView.js?v=20260824-production-v201x'),
  storyboard: () => import('./views/storyboardView.js?v=20260824-production-v201x'),
  final: () => import('./views/finalView.js?v=20260824-production-v201x'),
  workflow: () => import('./views/workflowView.js?v=20260824-production-v201x'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260824-production-v201x');
