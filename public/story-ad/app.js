import { createProjectStore } from './store/projectStore.js?v=20260829-production-v276e';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260829-production-v276e';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260829-production-v276e';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260829-production-v276e'),
  assets: () => import('./views/assetCenterView.js?v=20260829-production-v276e'),
  scene: () => import('./views/sceneWorldPage.js?v=20260829-production-v276e'),
  plot: () => import('./views/plotRoomView.js?v=20260829-production-v276e'),
  storyboard: () => import('./views/storyboardView.js?v=20260829-production-v276e'),
  final: () => import('./views/finalView.js?v=20260829-production-v276e'),
  workflow: () => import('./views/workflowView.js?v=20260829-production-v276e'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260829-production-v276e');
