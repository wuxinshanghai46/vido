import { createProjectStore } from './store/projectStore.js?v=20260829-production-v273c';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260829-production-v273c';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260829-production-v273c';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260829-production-v273c'),
  assets: () => import('./views/assetCenterView.js?v=20260829-production-v273c'),
  scene: () => import('./views/sceneWorldPage.js?v=20260829-production-v273c'),
  plot: () => import('./views/plotRoomView.js?v=20260829-production-v273c'),
  storyboard: () => import('./views/storyboardView.js?v=20260829-production-v273c'),
  final: () => import('./views/finalView.js?v=20260829-production-v273c'),
  workflow: () => import('./views/workflowView.js?v=20260829-production-v273c'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260829-production-v273c');
