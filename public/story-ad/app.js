import { createProjectStore } from './store/projectStore.js?v=20260825-production-v205';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260825-production-v205';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260825-production-v205';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260825-production-v205'),
  assets: () => import('./views/assetCenterView.js?v=20260825-production-v205'),
  scene: () => import('./views/sceneWorldPage.js?v=20260825-production-v205'),
  plot: () => import('./views/plotRoomView.js?v=20260825-production-v205'),
  storyboard: () => import('./views/storyboardView.js?v=20260825-production-v205'),
  final: () => import('./views/finalView.js?v=20260825-production-v205'),
  workflow: () => import('./views/workflowView.js?v=20260825-production-v205'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260825-production-v205');
