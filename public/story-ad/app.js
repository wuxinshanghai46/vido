import { createProjectStore } from './store/projectStore.js?v=20260815-asset-ui-v62';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260815-asset-ui-v62'),
  assets: () => import('./views/assetCenterView.js?v=20260815-asset-ui-v62'),
  scene: () => import('./views/sceneWorldPage.js?v=20260815-asset-ui-v62'),
  plot: () => import('./views/plotRoomView.js?v=20260815-asset-ui-v62'),
  storyboard: () => import('./views/storyboardView.js?v=20260815-asset-ui-v62'),
  final: () => import('./views/finalView.js?v=20260815-asset-ui-v62'),
  workflow: () => import('./views/workflowView.js?v=20260815-asset-ui-v62'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260815-asset-ui-v62');
