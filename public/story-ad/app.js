import { createProjectStore } from './store/projectStore.js?v=20260827-production-v233g';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260827-production-v233g';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260827-production-v233g';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260827-production-v233g'),
  assets: () => import('./views/assetCenterView.js?v=20260827-production-v233g'),
  scene: () => import('./views/sceneWorldPage.js?v=20260827-production-v233g'),
  plot: () => import('./views/plotRoomView.js?v=20260827-production-v233g'),
  storyboard: () => import('./views/storyboardView.js?v=20260827-production-v233g'),
  final: () => import('./views/finalView.js?v=20260827-production-v233g'),
  workflow: () => import('./views/workflowView.js?v=20260827-production-v233g'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260827-production-v233g');
