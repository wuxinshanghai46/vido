import { createProjectStore } from './store/projectStore.js?v=20260830-production-v291d';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260830-production-v291d';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260830-production-v291d';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260830-production-v291d'),
  assets: () => import('./views/assetCenterView.js?v=20260830-production-v291d'),
  scene: () => import('./views/sceneWorldPage.js?v=20260830-production-v291d'),
  plot: () => import('./views/plotRoomView.js?v=20260830-production-v291d'),
  storyboard: () => import('./views/storyboardView.js?v=20260830-production-v291d'),
  final: () => import('./views/finalView.js?v=20260830-production-v291d'),
  workflow: () => import('./views/workflowView.js?v=20260830-production-v291d'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260830-production-v291d');
