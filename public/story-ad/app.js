import { createProjectStore } from './store/projectStore.js?v=20260827-production-v237b';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260827-production-v237b';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260827-production-v237b';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260827-production-v237b'),
  assets: () => import('./views/assetCenterView.js?v=20260827-production-v237b'),
  scene: () => import('./views/sceneWorldPage.js?v=20260827-production-v237b'),
  plot: () => import('./views/plotRoomView.js?v=20260827-production-v237b'),
  storyboard: () => import('./views/storyboardView.js?v=20260827-production-v237b'),
  final: () => import('./views/finalView.js?v=20260827-production-v237b'),
  workflow: () => import('./views/workflowView.js?v=20260827-production-v237b'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260827-production-v237b');
