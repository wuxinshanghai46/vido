import { createProjectStore } from './store/projectStore.js?v=20260824-production-v204i';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260824-production-v204i';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260824-production-v204i';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260824-production-v204i'),
  assets: () => import('./views/assetCenterView.js?v=20260824-production-v204i'),
  scene: () => import('./views/sceneWorldPage.js?v=20260824-production-v204i'),
  plot: () => import('./views/plotRoomView.js?v=20260824-production-v204i'),
  storyboard: () => import('./views/storyboardView.js?v=20260824-production-v204i'),
  final: () => import('./views/finalView.js?v=20260824-production-v204i'),
  workflow: () => import('./views/workflowView.js?v=20260824-production-v204i'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260824-production-v204i');
