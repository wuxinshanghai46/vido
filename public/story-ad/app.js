import { createProjectStore } from './store/projectStore.js?v=20260824-production-v201z';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260824-production-v201z';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260824-production-v201z';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260824-production-v201z'),
  assets: () => import('./views/assetCenterView.js?v=20260824-production-v201z'),
  scene: () => import('./views/sceneWorldPage.js?v=20260824-production-v201z'),
  plot: () => import('./views/plotRoomView.js?v=20260824-production-v201z'),
  storyboard: () => import('./views/storyboardView.js?v=20260824-production-v201z'),
  final: () => import('./views/finalView.js?v=20260824-production-v201z'),
  workflow: () => import('./views/workflowView.js?v=20260824-production-v201z'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260824-production-v201z');
