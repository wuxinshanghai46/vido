import { createProjectStore } from './store/projectStore.js?v=20260815-asset-generation-guidance-v60';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260815-asset-generation-guidance-v60';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260815-asset-generation-guidance-v60';
import { confirmDialog } from './components/dialog.js?v=20260815-asset-generation-guidance-v60';
import { historicalStepReadOnly } from './workspaceHistoryMode.js?v=20260815-asset-generation-guidance-v60';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260815-asset-generation-guidance-v60'),
  assets: () => import('./views/assetCenterView.js?v=20260815-asset-generation-guidance-v60'),
  scene: () => import('./views/sceneWorldPage.js?v=20260815-asset-generation-guidance-v60'),
  plot: () => import('./views/plotRoomView.js?v=20260815-asset-generation-guidance-v60'),
  storyboard: () => import('./views/storyboardView.js?v=20260815-asset-generation-guidance-v60'),
  final: () => import('./views/finalView.js?v=20260815-asset-generation-guidance-v60'),
  workflow: () => import('./views/workflowView.js?v=20260815-asset-generation-guidance-v60'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260815-asset-generation-guidance-v60');
