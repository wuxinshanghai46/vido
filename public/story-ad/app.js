import { createProjectStore } from './store/projectStore.js?v=20260904-production-v450';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260904-production-v450';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260904-production-v450';
...
const editorTool = new URLSearchParams(location.search).get('tool') === 'editor'
  ? await import('./views/editorToolCenter.js?v=20260904-production-v450') : null;
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260904-production-v450'),
  assets: () => import('./views/assetCenterView.js?v=20260904-production-v450'),
  scene: () => import('./views/sceneWorldPage.js?v=20260904-production-v450'),
  plot: () => import('./views/plotRoomView.js?v=20260904-production-v450'),
  storyboard: () => import('./views/storyboardView.js?v=20260904-production-v450'),
  compose: () => import('./views/finalView.js?v=20260904-production-v450'),
  workflow: () => import('./views/workflowView.js?v=20260904-production-v450'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260904-production-v450');
