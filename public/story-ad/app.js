import { createProjectStore } from './store/projectStore.js?v=20260901-production-v373';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260901-production-v373';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260901-production-v373';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260901-production-v373'),
  assets: () => import('./views/assetCenterView.js?v=20260901-production-v373'),
  scene: () => import('./views/sceneWorldPage.js?v=20260901-production-v373'),
  plot: () => import('./views/plotRoomView.js?v=20260901-production-v373'),
  storyboard: () => import('./views/storyboardView.js?v=20260901-production-v373'),
  sound: () => import('./views/finalSoundView.js?v=20260901-production-v373'),
  compose: () => import('./views/finalView.js?v=20260901-production-v373'),
  edit: () => import('./views/finalEditView.js?v=20260901-production-v373'),
  workflow: () => import('./views/workflowView.js?v=20260901-production-v373'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260901-production-v373');
