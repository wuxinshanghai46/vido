import { createProjectStore } from './store/projectStore.js?v=20260824-production-v201an';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260824-production-v201an';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260824-production-v201an';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260824-production-v201an'),
  assets: () => import('./views/assetCenterView.js?v=20260824-production-v201an'),
  scene: () => import('./views/sceneWorldPage.js?v=20260824-production-v201an'),
  plot: () => import('./views/plotRoomView.js?v=20260824-production-v201an'),
  storyboard: () => import('./views/storyboardView.js?v=20260824-production-v201an'),
  final: () => import('./views/finalView.js?v=20260824-production-v201an'),
  workflow: () => import('./views/workflowView.js?v=20260824-production-v201an'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260824-production-v201an');
