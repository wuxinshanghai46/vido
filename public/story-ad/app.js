import { createProjectStore } from './store/projectStore.js?v=20260813-sr9-v2';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, toast } from './components/ui.js?v=20260813-sr9-v2';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260813-sr9-v2';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260813-sr9-v2'),
  assets: () => import('./views/assetCenterView.js?v=20260813-sr9-v2'),
  scene: () => import('./views/sceneWorldPage.js?v=20260813-sr9-v2'),
  plot: () => import('./views/plotRoomView.js?v=20260813-sr9-v2'),
  storyboard: () => import('./views/storyboardView.js?v=20260813-sr9-v2'),
  final: () => import('./views/finalView.js?v=20260813-sr9-v2'),
  workflow: () => import('./views/workflowView.js?v=20260813-sr9-v2'),
};
