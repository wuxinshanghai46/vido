import { createProjectStore } from './store/projectStore.js?v=20260826-production-v230o';
import { bindHoverVideoPreviews, escapeHtml, formatDate, generationProgressPanel, refreshElapsedLabels, setButtonBusy, statusView, syncInlineGenerationProgress, toast } from './components/ui.js?v=20260826-production-v230o';
import { assertCurrentRelease, startReleaseHeartbeat } from './api.js?v=20260826-production-v230o';
...
const VIEW_MODULES = {
  brief: () => import('./views/briefView.js?v=20260826-production-v230o'),
  assets: () => import('./views/assetCenterView.js?v=20260826-production-v230o'),
  scene: () => import('./views/sceneWorldPage.js?v=20260826-production-v230o'),
  plot: () => import('./views/plotRoomView.js?v=20260826-production-v230o'),
  storyboard: () => import('./views/storyboardView.js?v=20260826-production-v230o'),
  final: () => import('./views/finalView.js?v=20260826-production-v230o'),
  workflow: () => import('./views/workflowView.js?v=20260826-production-v230o'),
};
...
document.addEventListener('input', async ({ target }) => {
  ...
  const filters = await import('./projectCenterFilters.js?v=20260826-production-v230o');
