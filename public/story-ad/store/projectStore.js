import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260826-production-v228f';
import { beginReferenceReplacement, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement } from './referenceReplacementState.js?v=20260826-production-v228f';
import { cancelReferenceAnalysisRequest, retryReferenceAnalysisRequest, retryReferenceImportRequest } from './referenceRetryStore.js?v=20260826-production-v228f';
import { loadProjectList } from './projectListStore.js?v=20260826-production-v228f';
import { loadProjectBundle, refreshProjectBundle } from './projectBundleStore.js?v=20260826-production-v228f';
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260826-production-v228f'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
