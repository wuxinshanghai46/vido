import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260829-production-v274b';
import { beginReferenceReplacement, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement } from './referenceReplacementState.js?v=20260829-production-v274b';
import { cancelReferenceAnalysisRequest, retryReferenceAnalysisRequest, retryReferenceImportRequest } from './referenceRetryStore.js?v=20260829-production-v274b';
import { loadProjectList } from './projectListStore.js?v=20260829-production-v274b';
import { loadProjectBundle, refreshProjectBundle } from './projectBundleStore.js?v=20260829-production-v274b';
import { beginStageSubmissionState } from './stageSubmissionState.js?v=20260829-production-v274b';
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260829-production-v274b'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
  ...
  return {
    ...
    runStage,
    saveScenePrompt: async (scene, prompt) => (await import('./scenePromptConfirmationStore.js?v=20260829-production-v274b')).saveScenePrompt({ state, request }, scene, prompt),
    saveBlueprint,
    saveStoryboard,
    saveSketches,
    upload,
