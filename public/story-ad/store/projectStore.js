import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260826-production-v230n';
import { beginReferenceReplacement, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement } from './referenceReplacementState.js?v=20260826-production-v230n';
import { cancelReferenceAnalysisRequest, retryReferenceAnalysisRequest, retryReferenceImportRequest } from './referenceRetryStore.js?v=20260826-production-v230n';
import { loadProjectList } from './projectListStore.js?v=20260826-production-v230n';
import { loadProjectBundle, refreshProjectBundle } from './projectBundleStore.js?v=20260826-production-v230n';
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260826-production-v230n'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
