import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260814-sr9-v10';
import { beginReferenceReplacement, beginReferenceRetry, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement, restoreReferenceRetry } from './referenceReplacementState.js?v=20260814-sr9-v10';
import { loadProjectList } from './projectListStore.js?v=20260814-sr9-v10';
...
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260814-sr9-v10'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
