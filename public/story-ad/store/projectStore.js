import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260825-production-v226a';
import { beginReferenceReplacement, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement } from './referenceReplacementState.js?v=20260825-production-v226a';
import { cancelReferenceAnalysisRequest, retryReferenceAnalysisRequest, retryReferenceImportRequest } from './referenceRetryStore.js?v=20260825-production-v226a';
import { loadProjectList } from './projectListStore.js?v=20260825-production-v226a';
import { loadProjectBundle, refreshProjectBundle } from './projectBundleStore.js?v=20260825-production-v226a';
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260825-production-v226a'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
