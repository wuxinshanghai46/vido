import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260829-production-v278b';
import { beginReferenceReplacement, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement } from './referenceReplacementState.js?v=20260829-production-v278b';
import { cancelReferenceAnalysisRequest, retryReferenceAnalysisRequest, retryReferenceImportRequest } from './referenceRetryStore.js?v=20260829-production-v278b';
import { loadProjectList } from './projectListStore.js?v=20260829-production-v278b';
import { loadProjectBundle, refreshProjectBundle } from './projectBundleStore.js?v=20260829-production-v278b';
import { beginStageSubmissionState } from './stageSubmissionState.js?v=20260829-production-v278b';
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260829-production-v278b'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
  ...
  return {
    ...
    startVideo,
    cancelGeneration,
    acceptCurrentScenes: async () => (await import('./sceneAcceptanceStore.js?v=20260829-production-v278b')).acceptCurrentScenes({ state, request, refreshSections }),
    clearProject,
    syncProgressPolling,
    stopProgressPolling,
    stopReferencePolling,
