import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260814-reference-recovery-v37';
import { beginReferenceReplacement, beginReferenceRetry, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement, restoreReferenceRetry } from './referenceReplacementState.js?v=20260814-reference-recovery-v37';
import { loadProjectList } from './projectListStore.js?v=20260814-reference-recovery-v37';
...
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260814-reference-recovery-v37'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
