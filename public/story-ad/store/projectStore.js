import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260826-production-v231b';
import { beginReferenceReplacement, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement } from './referenceReplacementState.js?v=20260826-production-v231b';
import { cancelReferenceAnalysisRequest, retryReferenceAnalysisRequest, retryReferenceImportRequest } from './referenceRetryStore.js?v=20260826-production-v231b';
import { loadProjectList } from './projectListStore.js?v=20260826-production-v231b';
import { loadProjectBundle, refreshProjectBundle } from './projectBundleStore.js?v=20260826-production-v231b';
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260826-production-v231b'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
  ...
  return {
    ...
    updateRequest,
    runStage,
    confirmScenePrompt: async scene => (await import('./scenePromptConfirmationStore.js?v=20260826-production-v231b')).confirmScenePrompt({ state, request, refreshSections }, scene),
    saveBlueprint,
    saveStoryboard,
    saveSketches,
    upload,
