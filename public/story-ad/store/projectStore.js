import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260820-dialogue-flow-v87';
import { beginReferenceReplacement, beginReferenceRetry, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement, restoreReferenceRetry } from './referenceReplacementState.js?v=20260820-dialogue-flow-v87';
import { loadProjectList } from './projectListStore.js?v=20260820-dialogue-flow-v87';
import { loadProjectBundle, refreshProjectBundle } from './projectBundleStore.js?v=20260820-dialogue-flow-v87';
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260820-dialogue-flow-v87'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
