import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260824-production-v204b';
import { beginReferenceReplacement, beginReferenceRetry, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement, restoreReferenceRetry } from './referenceReplacementState.js?v=20260824-production-v204b';
import { loadProjectList } from './projectListStore.js?v=20260824-production-v204b';
import { loadProjectBundle, refreshProjectBundle } from './projectBundleStore.js?v=20260824-production-v204b';
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260824-production-v204b'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
