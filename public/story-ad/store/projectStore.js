import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260813-sr5-v1';
import { beginReferenceReplacement, beginReferenceRetry, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement, restoreReferenceRetry } from './referenceReplacementState.js?v=20260813-sr5-v1';
import { loadProjectList } from './projectListStore.js?v=20260813-sr5-v1';
...
export function createProjectStore() {
  ...
  async function loadMediaPage(options = {}) {
  ...
  async function loadMoreMedia(kind = 'keyframes', limit = 24) {
    ...
    const catalog = await loadMediaPage({ kind, offset: current.length, limit });
