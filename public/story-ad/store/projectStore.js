import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260823-production-v201f';
import { beginReferenceReplacement, beginReferenceRetry, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement, restoreReferenceRetry } from './referenceReplacementState.js?v=20260823-production-v201f';
import { loadProjectList } from './projectListStore.js?v=20260823-production-v201f';
import { loadProjectBundle, refreshProjectBundle } from './projectBundleStore.js?v=20260823-production-v201f';
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260823-production-v201f'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
