import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260825-production-v205';
import { beginReferenceReplacement, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement } from './referenceReplacementState.js?v=20260825-production-v205';
import { retryReferenceAnalysisRequest, retryReferenceImportRequest } from './referenceRetryStore.js?v=20260825-production-v205';
import { loadProjectList } from './projectListStore.js?v=20260825-production-v205';
import { loadProjectBundle, refreshProjectBundle } from './projectBundleStore.js?v=20260825-production-v205';
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260825-production-v205'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
