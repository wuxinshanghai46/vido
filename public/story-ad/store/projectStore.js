import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260821-guided-workspace-v102';
import { beginReferenceReplacement, beginReferenceRetry, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement, restoreReferenceRetry } from './referenceReplacementState.js?v=20260821-guided-workspace-v102';
import { loadProjectList } from './projectListStore.js?v=20260821-guided-workspace-v102';
import { loadProjectBundle, refreshProjectBundle } from './projectBundleStore.js?v=20260821-guided-workspace-v102';
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260821-guided-workspace-v102'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
