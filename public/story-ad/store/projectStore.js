import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260815-asset-ui-v60';
import { beginReferenceReplacement, beginReferenceRetry, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement, restoreReferenceRetry } from './referenceReplacementState.js?v=20260815-asset-ui-v60';
import { loadProjectList } from './projectListStore.js?v=20260815-asset-ui-v60';
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260815-asset-ui-v60'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
