import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260823-person-profile-v200b';
import { beginReferenceReplacement, beginReferenceRetry, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement, restoreReferenceRetry } from './referenceReplacementState.js?v=20260823-person-profile-v200b';
import { loadProjectList } from './projectListStore.js?v=20260823-person-profile-v200b';
import { loadProjectBundle, refreshProjectBundle } from './projectBundleStore.js?v=20260823-person-profile-v200b';
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260823-person-profile-v200b'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
