import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260826-production-v230';
import { beginReferenceReplacement, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement } from './referenceReplacementState.js?v=20260826-production-v230';
import { cancelReferenceAnalysisRequest, retryReferenceAnalysisRequest, retryReferenceImportRequest } from './referenceRetryStore.js?v=20260826-production-v230';
import { loadProjectList } from './projectListStore.js?v=20260826-production-v230';
import { loadProjectBundle, refreshProjectBundle } from './projectBundleStore.js?v=20260826-production-v230';
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260826-production-v230'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
