import { request, uploadAsset, uploadReferenceVideo } from '../api.js?v=20260826-production-v231a';
import { beginReferenceReplacement, referenceSyncInterrupted, replacementCurrent, removeProjectReference, restoreReferenceReplacement } from './referenceReplacementState.js?v=20260826-production-v231a';
import { cancelReferenceAnalysisRequest, retryReferenceAnalysisRequest, retryReferenceImportRequest } from './referenceRetryStore.js?v=20260826-production-v231a';
import { loadProjectList } from './projectListStore.js?v=20260826-production-v231a';
import { loadProjectBundle, refreshProjectBundle } from './projectBundleStore.js?v=20260826-production-v231a';
export function createProjectStore() {
  ...
  const mediaStore = () => import('./mediaCatalogStore.js?v=20260826-production-v231a'), loadMediaPage = async options => (await mediaStore()).loadMediaPage({ request, state }, options);
  ...
  return {
    ...
    updateRequest,
    runStage,
    confirmScenePrompt: async scene => (await import('./scenePromptConfirmationStore.js?v=20260826-production-v231a')).confirmScenePrompt({ state, request, refreshSections }, scene),
    saveBlueprint,
    saveStoryboard,
    saveSketches,
    upload,
