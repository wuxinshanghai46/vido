...
import { escapeHtml, setButtonBusy, toast } from '../components/ui.js?v=20260904-production-v470';
...
async function renderEditor(host, context, options = {}) {
  ...
  audioEditor?.addEventListener('toggle', async () => {
    ...
    try {
      const feature = await import('./finalSoundDesignView.js?v=20260904-production-v470');
