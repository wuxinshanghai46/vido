import { generationElapsedTimeTag, emptyState, escapeHtml, setButtonBusy, toast } from '../components/ui.js?v=20260904-production-v463';
import { bindMoreMedia, moreMediaButton } from './finalMediaPagination.js?v=20260904-production-v463';
import { bindGenerationModelPicker, loadGenerationModelPicker } from './generationModelPicker.js?v=20260904-production-v463';
import { clipReviewState, finalVideoPlayer, finalVideoUrl, mediaCard } from './clipReviewPresentation.js?v=20260904-production-v463';
...
export async function mount(host, context) {
  ...
  const openEditor = async () => {
    const editor = await import('./finalEditView.js?v=20260904-production-v463');
