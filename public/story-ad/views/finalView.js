...
import { bindMoreMedia, moreMediaButton } from './finalMediaPagination.js?v=20260904-production-v446';
import { bindGenerationModelPicker, loadGenerationModelPicker } from './generationModelPicker.js?v=20260904-production-v446';
import { clipReviewState, mediaCard } from './clipReviewPresentation.js?v=20260904-production-v446';
...
export async function mount(host, context) {
  ...
  const openEditor = async () => {
    const editor = await import('./finalEditView.js?v=20260904-production-v446');
