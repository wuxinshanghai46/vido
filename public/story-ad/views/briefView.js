import { request } from '../api.js?v=20260904-production-v427';
import { elapsedTimeTag, escapeHtml, setButtonBusy, toast } from '../components/ui.js?v=20260904-production-v427';
import { confirmDialog, promptDialog } from '../components/dialog.js?v=20260904-production-v427';
import { briefSettingsSummary } from './briefSettingsSummary.js?v=20260904-production-v427';
import { worldSettingFields } from './briefWorldSettings.js?v=20260904-production-v427';
import { bindNarrativeRecognitionLayout } from './briefNarrativeRecognition.js?v=20260904-production-v427';
import { referenceProgress as renderReferenceProgress } from './referenceProgressCard.js?v=20260904-production-v427';
import { assertBriefReadback } from './briefTextContract.js?v=20260904-production-v427';
import { confirmContentModeMigration } from './briefContentModeMigration.js?v=20260904-production-v427';
import { BRIEF_MATERIALS } from './briefMaterials.js?v=20260904-production-v427';
import { bindAdvancedReferenceControls, renderAdvancedReferenceControls } from './briefAdvancedConfig.js?v=20260904-production-v427';
import { bindBriefDialogueWorkflow, briefDialogueMarkup, referenceNextStepDescription } from './briefDialoguePanel.js?v=20260904-production-v427';
import { syncReferenceDialogueStatus } from './briefReferenceDialogueState.js?v=20260904-production-v427';
import { referenceActionState, syncReferenceAction } from './briefReferenceActionState.js?v=20260904-production-v427';
import { bindBriefViewport, briefDialogueAssist } from './briefDialogueRuntime.js?v=20260904-production-v427';
import { bindBriefSettingsModal } from './briefSettingsModal.js?v=20260904-production-v427';
import { formPayload } from './briefFormPayload.js?v=20260904-production-v427';
import { bindBriefReferenceRecovery } from './briefReferenceRecovery.js?v=20260904-production-v427';
import { durationOptionsMarkup } from './briefDurationOptions.js?v=20260904-production-v427';
...
<div class="brief-side-world-grid">${worldSettingFields(worldProfile, escapeHtml, { formId: 'storyAdBriefForm' })}</div>
  ...
  async function syncReferenceUnderstanding(reference = {}) {
    ...
    const module = await import('./referenceUnderstandingView.js?v=20260904-production-v427');
