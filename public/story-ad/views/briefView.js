import { request } from '../api.js?v=20260827-production-v236f';
import { elapsedTimeTag, escapeHtml, setButtonBusy, toast } from '../components/ui.js?v=20260827-production-v236f';
import { confirmDialog, promptDialog } from '../components/dialog.js?v=20260827-production-v236f';
import { briefSettingsSummary } from './briefSettingsSummary.js?v=20260827-production-v236f';
import { worldSettingFields } from './briefWorldSettings.js?v=20260827-production-v236f';
import { bindNarrativeRecognitionLayout } from './briefNarrativeRecognition.js?v=20260827-production-v236f';
import { referenceProgress as renderReferenceProgress } from './referenceProgressCard.js?v=20260827-production-v236f';
import { assertBriefReadback } from './briefTextContract.js?v=20260827-production-v236f';
import { confirmContentModeMigration } from './briefContentModeMigration.js?v=20260827-production-v236f';
import { BRIEF_MATERIALS } from './briefMaterials.js?v=20260827-production-v236f';
import { bindAdvancedReferenceControls, renderAdvancedReferenceControls } from './briefAdvancedConfig.js?v=20260827-production-v236f';
import { bindBriefDialogueWorkflow, briefDialogueMarkup, referenceNextStepDescription } from './briefDialoguePanel.js?v=20260827-production-v236f';
import { syncReferenceDialogueStatus } from './briefReferenceDialogueState.js?v=20260827-production-v236f';
import { referenceActionState, syncReferenceAction } from './briefReferenceActionState.js?v=20260827-production-v236f';
import { bindBriefViewport, briefDialogueAssist } from './briefDialogueRuntime.js?v=20260827-production-v236f';
import { bindBriefSettingsModal } from './briefSettingsModal.js?v=20260827-production-v236f';
import { formPayload } from './briefFormPayload.js?v=20260827-production-v236f';
import { bindBriefReferenceRecovery } from './briefReferenceRecovery.js?v=20260827-production-v236f';
import { durationOptionsMarkup } from './briefDurationOptions.js?v=20260827-production-v236f';
...
<div class="brief-side-world-grid">${worldSettingFields(worldProfile, escapeHtml, { formId: 'storyAdBriefForm' })}</div>
  ...
  async function syncReferenceUnderstanding(reference = {}) {
    ...
    const module = await import('./referenceUnderstandingView.js?v=20260827-production-v236f');
