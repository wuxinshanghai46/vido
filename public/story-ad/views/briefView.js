import { request } from '../api.js?v=20260827-production-v236g';
import { elapsedTimeTag, escapeHtml, setButtonBusy, toast } from '../components/ui.js?v=20260827-production-v236g';
import { confirmDialog, promptDialog } from '../components/dialog.js?v=20260827-production-v236g';
import { briefSettingsSummary } from './briefSettingsSummary.js?v=20260827-production-v236g';
import { worldSettingFields } from './briefWorldSettings.js?v=20260827-production-v236g';
import { bindNarrativeRecognitionLayout } from './briefNarrativeRecognition.js?v=20260827-production-v236g';
import { referenceProgress as renderReferenceProgress } from './referenceProgressCard.js?v=20260827-production-v236g';
import { assertBriefReadback } from './briefTextContract.js?v=20260827-production-v236g';
import { confirmContentModeMigration } from './briefContentModeMigration.js?v=20260827-production-v236g';
import { BRIEF_MATERIALS } from './briefMaterials.js?v=20260827-production-v236g';
import { bindAdvancedReferenceControls, renderAdvancedReferenceControls } from './briefAdvancedConfig.js?v=20260827-production-v236g';
import { bindBriefDialogueWorkflow, briefDialogueMarkup, referenceNextStepDescription } from './briefDialoguePanel.js?v=20260827-production-v236g';
import { syncReferenceDialogueStatus } from './briefReferenceDialogueState.js?v=20260827-production-v236g';
import { referenceActionState, syncReferenceAction } from './briefReferenceActionState.js?v=20260827-production-v236g';
import { bindBriefViewport, briefDialogueAssist } from './briefDialogueRuntime.js?v=20260827-production-v236g';
import { bindBriefSettingsModal } from './briefSettingsModal.js?v=20260827-production-v236g';
import { formPayload } from './briefFormPayload.js?v=20260827-production-v236g';
import { bindBriefReferenceRecovery } from './briefReferenceRecovery.js?v=20260827-production-v236g';
import { durationOptionsMarkup } from './briefDurationOptions.js?v=20260827-production-v236g';
...
<div class="brief-side-world-grid">${worldSettingFields(worldProfile, escapeHtml, { formId: 'storyAdBriefForm' })}</div>
  ...
  async function syncReferenceUnderstanding(reference = {}) {
    ...
    const module = await import('./referenceUnderstandingView.js?v=20260827-production-v236g');
