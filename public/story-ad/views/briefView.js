import { request } from '../api.js?v=20260824-production-v204g';
import { elapsedTimeTag, escapeHtml, setButtonBusy, toast } from '../components/ui.js?v=20260824-production-v204g';
import { confirmDialog, promptDialog } from '../components/dialog.js?v=20260824-production-v204g';
import { briefSettingsSummary } from './briefSettingsSummary.js?v=20260824-production-v204g';
import { worldSettingFields } from './briefWorldSettings.js?v=20260824-production-v204g';
import { bindNarrativeRecognitionLayout } from './briefNarrativeRecognition.js?v=20260824-production-v204g';
import { referenceProgress as renderReferenceProgress } from './referenceProgressCard.js?v=20260824-production-v204g';
import { assertBriefReadback } from './briefTextContract.js?v=20260824-production-v204g';
import { confirmContentModeMigration } from './briefContentModeMigration.js?v=20260824-production-v204g';
import { BRIEF_MATERIALS } from './briefMaterials.js?v=20260824-production-v204g';
import { bindAdvancedReferenceControls, renderAdvancedReferenceControls } from './briefAdvancedConfig.js?v=20260824-production-v204g';
import { bindBriefDialogueWorkflow, briefDialogueMarkup, referenceNextStepDescription } from './briefDialoguePanel.js?v=20260824-production-v204g';
import { syncReferenceDialogueStatus } from './briefReferenceDialogueState.js?v=20260824-production-v204g';
import { referenceActionState, syncReferenceAction } from './briefReferenceActionState.js?v=20260824-production-v204g';
import { bindBriefViewport, briefDialogueAssist } from './briefDialogueRuntime.js?v=20260824-production-v204g';
import { bindBriefSettingsModal } from './briefSettingsModal.js?v=20260824-production-v204g';
import { formPayload } from './briefFormPayload.js?v=20260824-production-v204g';
import { bindBriefReferenceRecovery } from './briefReferenceRecovery.js?v=20260824-production-v204g';
import { durationOptionsMarkup } from './briefDurationOptions.js?v=20260824-production-v204g';
...
<div class="brief-side-world-grid">${worldSettingFields(worldProfile, escapeHtml, { formId: 'storyAdBriefForm' })}</div>
  ...
  async function syncReferenceUnderstanding(reference = {}) {
    ...
    const module = await import('./referenceUnderstandingView.js?v=20260824-production-v204g');
