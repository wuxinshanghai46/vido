import { request } from '../api.js?v=20260827-production-v234a';
import { elapsedTimeTag, escapeHtml, setButtonBusy, toast } from '../components/ui.js?v=20260827-production-v234a';
import { confirmDialog, promptDialog } from '../components/dialog.js?v=20260827-production-v234a';
import { briefSettingsSummary } from './briefSettingsSummary.js?v=20260827-production-v234a';
import { worldSettingFields } from './briefWorldSettings.js?v=20260827-production-v234a';
import { bindNarrativeRecognitionLayout } from './briefNarrativeRecognition.js?v=20260827-production-v234a';
import { referenceProgress as renderReferenceProgress } from './referenceProgressCard.js?v=20260827-production-v234a';
import { assertBriefReadback } from './briefTextContract.js?v=20260827-production-v234a';
import { confirmContentModeMigration } from './briefContentModeMigration.js?v=20260827-production-v234a';
import { BRIEF_MATERIALS } from './briefMaterials.js?v=20260827-production-v234a';
import { bindAdvancedReferenceControls, renderAdvancedReferenceControls } from './briefAdvancedConfig.js?v=20260827-production-v234a';
import { bindBriefDialogueWorkflow, briefDialogueMarkup, referenceNextStepDescription } from './briefDialoguePanel.js?v=20260827-production-v234a';
import { syncReferenceDialogueStatus } from './briefReferenceDialogueState.js?v=20260827-production-v234a';
import { referenceActionState, syncReferenceAction } from './briefReferenceActionState.js?v=20260827-production-v234a';
import { bindBriefViewport, briefDialogueAssist } from './briefDialogueRuntime.js?v=20260827-production-v234a';
import { bindBriefSettingsModal } from './briefSettingsModal.js?v=20260827-production-v234a';
import { formPayload } from './briefFormPayload.js?v=20260827-production-v234a';
import { bindBriefReferenceRecovery } from './briefReferenceRecovery.js?v=20260827-production-v234a';
import { durationOptionsMarkup } from './briefDurationOptions.js?v=20260827-production-v234a';
...
<div class="brief-side-world-grid">${worldSettingFields(worldProfile, escapeHtml, { formId: 'storyAdBriefForm' })}</div>
  ...
  async function syncReferenceUnderstanding(reference = {}) {
    ...
    const module = await import('./referenceUnderstandingView.js?v=20260827-production-v234a');
