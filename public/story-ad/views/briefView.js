...
import { elapsedTimeTag, escapeHtml, setButtonBusy, toast } from '../components/ui.js?v=20260822-reference-blueprint-complete-v150';
import { confirmDialog, promptDialog } from '../components/dialog.js?v=20260822-reference-blueprint-complete-v150';
import { briefSettingsSummary } from './briefSettingsSummary.js?v=20260822-reference-blueprint-complete-v150';
import { worldSettingFields } from './briefWorldSettings.js?v=20260822-reference-blueprint-complete-v150';
import { bindNarrativeRecognitionLayout } from './briefNarrativeRecognition.js?v=20260822-reference-blueprint-complete-v150';
import { referenceProgress as renderReferenceProgress } from './referenceProgressCard.js?v=20260822-reference-blueprint-complete-v150';
import { assertBriefReadback } from './briefTextContract.js?v=20260822-reference-blueprint-complete-v150';
...
<div class="brief-side-world-grid">${worldSettingFields(worldProfile, escapeHtml, { formId: 'storyAdBriefForm' })}</div>
  ...
  async function syncReferenceUnderstanding(reference = {}) {
    ...
    const module = await import('./referenceUnderstandingView.js?v=20260822-reference-blueprint-complete-v150');
