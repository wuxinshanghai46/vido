...
export async function mount(host, context) {
  ...
  host.innerHTML = `
    <section class="view-head post-production-head">
      <div><span class="stage-kicker">第 6 步</span><h1>声音</h1><p>只处理旁白、人物对白、场景声、动作音效和背景音乐。全部试听确认后，才能进入视频生成与合成。</p></div>
      <div class="view-actions">${approved ? '<button class="btn primary" type="button" data-next-compose>进入视频与合成</button>' : ''}</div>
    </section>
