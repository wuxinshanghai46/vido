...
import { escapeHtml, mediaPreview, toast } from '../components/ui.js?v=20260829-production-v270';
import { promptDialog } from '../components/dialog.js?v=20260829-production-v270';
import { list, worldById } from './sceneWorldData.js?v=20260829-production-v270';
...
function initSceneWorldViewer({ overlay, bundle, world, authority }) {
  ...
  const showPanorama = async node => {
    ...
    try {
      const module = await import('./panoramaViewer.js?v=20260829-production-v270');
...
async function openSceneWorldStudio(bundle, world) {
  const authority = await import('./sceneWorldAuthorityPlan.js?v=20260829-production-v270');
