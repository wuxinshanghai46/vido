...
import { personDossierShowcase } from './personDossierShowcase.js?v=20260904-production-v451';
import { bindSceneDossierCard, renderSceneDossierCard } from './sceneDossierCard.js?v=20260904-production-v451';
import { publicSceneQaReason } from './sceneQaPublicState.js?v=20260904-production-v451';
import { productDetails } from './assetCenterMaterialReference.js?v=20260904-production-v451';
...
export function openAssetDrawer(item, group, handlers = {}, renderers = {}) {
  ...
  if (editablePerson && drawer.querySelector('[name="generation_prompt"]')) import('./personPromptAutosave.js?v=20260904-production-v451').then(module => {
