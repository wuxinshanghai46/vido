import { escapeHtml, mediaPreview } from '../components/ui.js?v=20260830-production-v291c';
import { bindMediaLightbox } from './mediaLightbox.js?v=20260830-production-v291c';
import { personDossierShowcase } from './personDossierShowcase.js?v=20260830-production-v291c';
import { bindSceneDossierCard, renderSceneDossierCard } from './sceneDossierCard.js?v=20260830-production-v291c';
import { publicSceneQaReason } from './sceneQaPublicState.js?v=20260830-production-v291c';
import { productDetails } from './assetCenterMaterialReference.js?v=20260830-production-v291c';
...
export function openAssetDrawer(item, group, handlers = {}, renderers = {}) {
  ...
  if (editablePerson && drawer.querySelector('[name="generation_prompt"]')) import('./personPromptAutosave.js?v=20260830-production-v291c').then(module => {
