import { escapeHtml, mediaPreview } from '../components/ui.js?v=20260827-production-v233f';
import { bindMediaLightbox } from './mediaLightbox.js?v=20260827-production-v233f';
import { personDossierShowcase } from './personDossierShowcase.js?v=20260827-production-v233f';
import { bindSceneDossierCard, renderSceneDossierCard } from './sceneDossierCard.js?v=20260827-production-v233f';
...
export function openAssetDrawer(item, group, handlers = {}, renderers = {}) {
  ...
  if (editablePerson && drawer.querySelector('[name="generation_prompt"]')) import('./personPromptAutosave.js?v=20260827-production-v233f').then(module => {
