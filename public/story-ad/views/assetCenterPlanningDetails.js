...
import { personDossierShowcase } from './personDossierShowcase.js?v=20260904-production-v467';
import { bindSceneDossierCard, renderSceneDossierCard } from './sceneDossierCard.js?v=20260904-production-v467';
import { publicSceneQaReason } from './sceneQaPublicState.js?v=20260904-production-v467';
import { productDetails } from './assetCenterMaterialReference.js?v=20260904-production-v467';
...
export function openAssetDrawer(item, group, handlers = {}, renderers = {}) {
  ...
  if (editablePerson && drawer.querySelector('[name="generation_prompt"]')) import('./personPromptAutosave.js?v=20260904-production-v467').then(module => {
