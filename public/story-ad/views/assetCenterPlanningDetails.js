import { escapeHtml, mediaPreview } from '../components/ui.js?v=20260827-production-v236a';
import { bindMediaLightbox } from './mediaLightbox.js?v=20260827-production-v236a';
import { personDossierShowcase } from './personDossierShowcase.js?v=20260827-production-v236a';
import { bindSceneDossierCard, renderSceneDossierCard } from './sceneDossierCard.js?v=20260827-production-v236a';
...
export function openAssetDrawer(item, group, handlers = {}, renderers = {}) {
  ...
  if (editablePerson && drawer.querySelector('[name="generation_prompt"]')) import('./personPromptAutosave.js?v=20260827-production-v236a').then(module => {
