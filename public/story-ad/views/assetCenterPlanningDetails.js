import { escapeHtml, mediaPreview } from '../components/ui.js?v=20260830-production-v289d';
import { bindMediaLightbox } from './mediaLightbox.js?v=20260830-production-v289d';
import { personDossierShowcase } from './personDossierShowcase.js?v=20260830-production-v289d';
import { bindSceneDossierCard, renderSceneDossierCard } from './sceneDossierCard.js?v=20260830-production-v289d';
import { publicSceneQaReason } from './sceneQaPublicState.js?v=20260830-production-v289d';
import { productDetails } from './assetCenterMaterialReference.js?v=20260830-production-v289d';
...
export function openAssetDrawer(item, group, handlers = {}, renderers = {}) {
  ...
  if (editablePerson && drawer.querySelector('[name="generation_prompt"]')) import('./personPromptAutosave.js?v=20260830-production-v289d').then(module => {
