import { escapeHtml, mediaPreview } from '../components/ui.js?v=20260831-production-v340';
import { bindMediaLightbox } from './mediaLightbox.js?v=20260831-production-v340';
import { personDossierShowcase } from './personDossierShowcase.js?v=20260831-production-v340';
import { bindSceneDossierCard, renderSceneDossierCard } from './sceneDossierCard.js?v=20260831-production-v340';
import { publicSceneQaReason } from './sceneQaPublicState.js?v=20260831-production-v340';
import { productDetails } from './assetCenterMaterialReference.js?v=20260831-production-v340';
...
export function openAssetDrawer(item, group, handlers = {}, renderers = {}) {
  ...
  if (editablePerson && drawer.querySelector('[name="generation_prompt"]')) import('./personPromptAutosave.js?v=20260831-production-v340').then(module => {
