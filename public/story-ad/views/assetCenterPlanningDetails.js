import { escapeHtml, mediaPreview } from '../components/ui.js?v=20260827-production-v233e';
import { bindMediaLightbox } from './mediaLightbox.js?v=20260827-production-v233e';
import { personDossierShowcase } from './personDossierShowcase.js?v=20260827-production-v233e';
import { bindSceneDossierCard, renderSceneDossierCard } from './sceneDossierCard.js?v=20260827-production-v233e';
...
export function openAssetDrawer(item, group, handlers = {}, renderers = {}) {
  ...
  if (editablePerson && drawer.querySelector('[name="generation_prompt"]')) import('./personPromptAutosave.js?v=20260827-production-v233e').then(module => {
