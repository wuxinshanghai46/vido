import { escapeHtml, mediaPreview } from '../components/ui.js?v=20260827-production-v239';
import { bindMediaLightbox } from './mediaLightbox.js?v=20260827-production-v239';
import { personDossierShowcase } from './personDossierShowcase.js?v=20260827-production-v239';
import { bindSceneDossierCard, renderSceneDossierCard } from './sceneDossierCard.js?v=20260827-production-v239';
...
export function openAssetDrawer(item, group, handlers = {}, renderers = {}) {
  ...
  if (editablePerson && drawer.querySelector('[name="generation_prompt"]')) import('./personPromptAutosave.js?v=20260827-production-v239').then(module => {
