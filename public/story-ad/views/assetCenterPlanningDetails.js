import { escapeHtml, mediaPreview } from '../components/ui.js?v=20260827-production-v238b';
import { bindMediaLightbox } from './mediaLightbox.js?v=20260827-production-v238b';
import { personDossierShowcase } from './personDossierShowcase.js?v=20260827-production-v238b';
import { bindSceneDossierCard, renderSceneDossierCard } from './sceneDossierCard.js?v=20260827-production-v238b';
...
export function openAssetDrawer(item, group, handlers = {}, renderers = {}) {
  ...
  if (editablePerson && drawer.querySelector('[name="generation_prompt"]')) import('./personPromptAutosave.js?v=20260827-production-v238b').then(module => {
