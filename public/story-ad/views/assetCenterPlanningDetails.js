import { escapeHtml, mediaPreview } from '../components/ui.js?v=20260827-production-v235c';
import { bindMediaLightbox } from './mediaLightbox.js?v=20260827-production-v235c';
import { personDossierShowcase } from './personDossierShowcase.js?v=20260827-production-v235c';
import { bindSceneDossierCard, renderSceneDossierCard } from './sceneDossierCard.js?v=20260827-production-v235c';
...
export function openAssetDrawer(item, group, handlers = {}, renderers = {}) {
  ...
  if (editablePerson && drawer.querySelector('[name="generation_prompt"]')) import('./personPromptAutosave.js?v=20260827-production-v235c').then(module => {
