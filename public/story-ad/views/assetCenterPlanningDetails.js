...
import { personDossierShowcase } from './personDossierShowcase.js?v=20260904-production-v468';
import { bindSceneDossierCard, renderSceneDossierCard } from './sceneDossierCard.js?v=20260904-production-v468';
import { publicSceneQaReason } from './sceneQaPublicState.js?v=20260904-production-v468';
import { productDetails } from './assetCenterMaterialReference.js?v=20260904-production-v468';
...
export function openAssetDrawer(item, group, handlers = {}, renderers = {}) {
  ...
  if (editablePerson && drawer.querySelector('[name="generation_prompt"]')) import('./personPromptAutosave.js?v=20260904-production-v468').then(module => {
