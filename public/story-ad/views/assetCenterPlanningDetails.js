import { escapeHtml, mediaPreview } from '../components/ui.js?v=20260830-production-v300';
import { bindMediaLightbox } from './mediaLightbox.js?v=20260830-production-v300';
import { personDossierShowcase } from './personDossierShowcase.js?v=20260830-production-v300';
import { bindSceneDossierCard, renderSceneDossierCard } from './sceneDossierCard.js?v=20260830-production-v300';
import { publicSceneQaReason } from './sceneQaPublicState.js?v=20260830-production-v300';
import { productDetails } from './assetCenterMaterialReference.js?v=20260830-production-v300';
...
export function openAssetDrawer(item, group, handlers = {}, renderers = {}) {
  ...
  if (editablePerson && drawer.querySelector('[name="generation_prompt"]')) import('./personPromptAutosave.js?v=20260830-production-v300').then(module => {
