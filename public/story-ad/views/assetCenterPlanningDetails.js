import { escapeHtml, mediaPreview } from '../components/ui.js?v=20260903-production-v425';
import { bindMediaLightbox } from './mediaLightbox.js?v=20260903-production-v425';
import { personDossierShowcase } from './personDossierShowcase.js?v=20260903-production-v425';
import { bindSceneDossierCard, renderSceneDossierCard } from './sceneDossierCard.js?v=20260903-production-v425';
import { publicSceneQaReason } from './sceneQaPublicState.js?v=20260903-production-v425';
import { productDetails } from './assetCenterMaterialReference.js?v=20260903-production-v425';
...
export function openAssetDrawer(item, group, handlers = {}, renderers = {}) {
  ...
  if (editablePerson && drawer.querySelector('[name="generation_prompt"]')) import('./personPromptAutosave.js?v=20260903-production-v425').then(module => {
