import { escapeHtml, mediaPreview } from '../components/ui.js?v=20260831-production-v329';
import { bindMediaLightbox } from './mediaLightbox.js?v=20260831-production-v329';
import { personDossierShowcase } from './personDossierShowcase.js?v=20260831-production-v329';
import { bindSceneDossierCard, renderSceneDossierCard } from './sceneDossierCard.js?v=20260831-production-v329';
import { publicSceneQaReason } from './sceneQaPublicState.js?v=20260831-production-v329';
import { productDetails } from './assetCenterMaterialReference.js?v=20260831-production-v329';
...
export function openAssetDrawer(item, group, handlers = {}, renderers = {}) {
  ...
  if (editablePerson && drawer.querySelector('[name="generation_prompt"]')) import('./personPromptAutosave.js?v=20260831-production-v329').then(module => {
