import { escapeHtml, mediaPreview } from '../components/ui.js?v=20260901-production-v362';
import { bindMediaLightbox } from './mediaLightbox.js?v=20260901-production-v362';
import { personDossierShowcase } from './personDossierShowcase.js?v=20260901-production-v362';
import { bindSceneDossierCard, renderSceneDossierCard } from './sceneDossierCard.js?v=20260901-production-v362';
import { publicSceneQaReason } from './sceneQaPublicState.js?v=20260901-production-v362';
import { productDetails } from './assetCenterMaterialReference.js?v=20260901-production-v362';
...
export function openAssetDrawer(item, group, handlers = {}, renderers = {}) {
  ...
  if (editablePerson && drawer.querySelector('[name="generation_prompt"]')) import('./personPromptAutosave.js?v=20260901-production-v362').then(module => {
