...
import { emptyState, escapeHtml, mediaPreview, setButtonBusy, toast } from '../components/ui.js?v=20260828-production-v240d';
import { inlineNodeEditor, saveInlineNode } from './workflowInlineEditor.js?v=20260828-production-v240d';
import { bindWorkflowDirectorSync, ensureWorkflowDirectorStyles, openWorkflowDirector, projectWorkflowDirectorNodes, workflowNodePanelMarkup, workflowNodePortMarkup } from './workflowDirectorNodes.js?v=20260828-production-v240d';
...
export async function mount(host, context) {
  ...
  if (!document.getElementById('story-ad-workflow-style')) { const link = Object.assign(document.createElement('link'), { id: 'story-ad-workflow-style', rel: 'stylesheet', href: '/story-ad/workflow.css?v=20260828-production-v240d' }); document.head.append(link); } ensureWorkflowDirectorStyles();
