...
import { emptyState, escapeHtml, mediaPreview, setButtonBusy, toast } from '../components/ui.js?v=20260831-production-v328';
import { inlineNodeEditor, saveInlineNode } from './workflowInlineEditor.js?v=20260831-production-v328';
import { bindWorkflowDirectorSync, ensureWorkflowDirectorStyles, openWorkflowDirector, projectWorkflowDirectorNodes, workflowNodePanelMarkup, workflowNodePortMarkup } from './workflowDirectorNodes.js?v=20260831-production-v328';
...
export async function mount(host, context) {
  ...
  if (!document.getElementById('story-ad-workflow-style')) { const link = Object.assign(document.createElement('link'), { id: 'story-ad-workflow-style', rel: 'stylesheet', href: '/story-ad/workflow.css?v=20260831-production-v328' }); document.head.append(link); } ensureWorkflowDirectorStyles();
