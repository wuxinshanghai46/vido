...
import { inlineNodeEditor, saveInlineNode } from './workflowInlineEditor.js?v=20260904-production-v460';
import { bindWorkflowDirectorSync, ensureWorkflowDirectorStyles, openWorkflowDirector, projectWorkflowDirectorNodes, workflowNodePanelMarkup, workflowNodePortMarkup } from './workflowDirectorNodes.js?v=20260904-production-v460';
...
export async function mount(host, context) {
  ...
  if (!document.getElementById('story-ad-workflow-style')) { const link = Object.assign(document.createElement('link'), { id: 'story-ad-workflow-style', rel: 'stylesheet', href: '/story-ad/workflow.css?v=20260904-production-v460' }); document.head.append(link); } ensureWorkflowDirectorStyles();
