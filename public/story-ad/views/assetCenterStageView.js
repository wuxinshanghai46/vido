import { personPlanTechnicalDetails } from './assetCenterTechnicalDetails.js?v=20260826-production-v230a';
...
export function assetPlanStageView({ generationActive = false, counts = {}, missingSubjectCount = 0, project = {}, isAdmin = false } = {}) {
  ...
  const failed = !generationActive && Boolean(diagnostics.error_code || diagnostics.error || project.error_code || project.error);
