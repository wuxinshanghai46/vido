import { escapeHtml, toast } from '../components/ui.js?v=20260826-production-v231a';
import { renderSceneCoverCard, sceneNeedsGeneration } from './sceneDossierCard.js?v=20260826-production-v231a';
...
export function renderSceneProductionCard(scene = {}, index = 0, options = {}) {
  ...
  return `<article class="scene-production-card" data-scene-card>
    ...
    <section class="scene-production-pane" data-scene-detail-pane="prompt" hidden><pre>${escapeHtml(prompt || '场景提示词尚未生成。')}</pre></section>
