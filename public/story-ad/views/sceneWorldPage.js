import { bindSceneWorldWorkspace } from './sceneWorldView.js?v=20260827-production-v236e';
import { setButtonBusy, toast } from '../components/ui.js?v=20260827-production-v236e';
import { bindScenePlanUpdate, scenePlanBlockedView } from './scenePlanStatus.js?v=20260827-production-v236e';
import { renderSceneProductionCard, scenePromptPreviewMarkup, scenePromptPreviewState, startInitialScenePlan } from './scenePromptPreview.js?v=20260827-production-v236e';
import { sceneNeedsGeneration } from './sceneDossierCard.js?v=20260827-production-v236e';
...
export async function mount(host, context) {
  ...
  const cleanupSceneCards = (await import('./sceneCardInteractions.js?v=20260827-production-v236e')).bindSceneCards(host, context);
