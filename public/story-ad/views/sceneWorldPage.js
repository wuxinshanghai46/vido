import { bindSceneWorldWorkspace } from './sceneWorldView.js?v=20260830-production-v289b';
import { bindScenePlanUpdate, scenePlanBlockedView } from './scenePlanStatus.js?v=20260830-production-v289b';
import { renderSceneProductionCard, scenePromptPreviewMarkup, scenePromptPreviewState, startInitialScenePlan } from './scenePromptPreview.js?v=20260830-production-v289b';
import { bindMediaLightbox } from './mediaLightbox.js?v=20260830-production-v289b';
import { buildSceneBatchActionPlan } from './sceneBatchActionPlan.js?v=20260830-production-v289b';
import { bindGenerationModelPicker, loadGenerationModelPicker } from './generationModelPicker.js?v=20260830-production-v289b';
import { normalizeSceneDossier } from './sceneDossierCard.js?v=20260830-production-v289b';
import { bindSceneConfirmAction } from './sceneQaPublicState.js?v=20260830-production-v289b';
...
export async function mount(host, context) {
  ...
  const sceneInteractions = await import('./sceneCardInteractions.js?v=20260830-production-v289b');
