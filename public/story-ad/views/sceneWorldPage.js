import { bindSceneWorldWorkspace } from './sceneWorldView.js?v=20260828-production-v245';
import { setButtonBusy, toast } from '../components/ui.js?v=20260828-production-v245';
import { bindScenePlanUpdate, scenePlanBlockedView } from './scenePlanStatus.js?v=20260828-production-v245';
import { renderSceneProductionCard, scenePendingAction, scenePromptPreviewMarkup, scenePromptPreviewState, startInitialScenePlan } from './scenePromptPreview.js?v=20260828-production-v245';
...
export async function mount(host, context) {
  ...
  const cleanupSceneCards = (await import('./sceneCardInteractions.js?v=20260828-production-v245')).bindSceneCards(host, context);
