import { bindSceneWorldWorkspace } from './sceneWorldView.js?v=20260827-production-v236d';
import { setButtonBusy, toast } from '../components/ui.js?v=20260827-production-v236d';
import { bindScenePlanUpdate, scenePlanBlockedView } from './scenePlanStatus.js?v=20260827-production-v236d';
import { renderSceneProductionCard, scenePromptPreviewMarkup, scenePromptPreviewState, startInitialScenePlan } from './scenePromptPreview.js?v=20260827-production-v236d';
import { sceneNeedsGeneration } from './sceneDossierCard.js?v=20260827-production-v236d';
...
export async function mount(host, context) {
  ...
  const cleanupSceneCards = (await import('./sceneCardInteractions.js?v=20260827-production-v236d')).bindSceneCards(host, context);
