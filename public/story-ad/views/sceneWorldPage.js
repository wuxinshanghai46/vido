import { bindSceneWorldWorkspace } from './sceneWorldView.js?v=20260829-production-v266';
import { setButtonBusy, toast } from '../components/ui.js?v=20260829-production-v266';
import { bindScenePlanUpdate, scenePlanBlockedView } from './scenePlanStatus.js?v=20260829-production-v266';
import { renderSceneProductionCard, scenePromptPreviewMarkup, scenePromptPreviewState, startInitialScenePlan } from './scenePromptPreview.js?v=20260829-production-v266';
import { bindMediaLightbox } from './mediaLightbox.js?v=20260829-production-v266';
import { buildSceneBatchActionPlan } from './sceneBatchActionPlan.js?v=20260829-production-v266';
import { bindGenerationModelPicker, loadGenerationModelPicker } from './generationModelPicker.js?v=20260829-production-v266';
import { sceneBatchProgressMarkup } from './sceneBatchProgressView.js?v=20260829-production-v266';
import { normalizeSceneDossier } from './sceneDossierCard.js?v=20260829-production-v266';
...
export async function mount(host, context) {
  ...
  const cleanupSceneCards = (await import('./sceneCardInteractions.js?v=20260829-production-v266')).bindSceneCards(host, context);
