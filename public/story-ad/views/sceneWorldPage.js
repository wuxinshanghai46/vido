import { bindSceneWorldWorkspace } from './sceneWorldView.js?v=20260829-production-v269';
import { setButtonBusy, toast } from '../components/ui.js?v=20260829-production-v269';
import { bindScenePlanUpdate, scenePlanBlockedView } from './scenePlanStatus.js?v=20260829-production-v269';
import { renderSceneProductionCard, scenePromptPreviewMarkup, scenePromptPreviewState, startInitialScenePlan } from './scenePromptPreview.js?v=20260829-production-v269';
import { bindMediaLightbox } from './mediaLightbox.js?v=20260829-production-v269';
import { buildSceneBatchActionPlan } from './sceneBatchActionPlan.js?v=20260829-production-v269';
import { bindGenerationModelPicker, loadGenerationModelPicker } from './generationModelPicker.js?v=20260829-production-v269';
import { normalizeSceneDossier } from './sceneDossierCard.js?v=20260829-production-v269';
...
export async function mount(host, context) {
  ...
  const cleanupSceneCards = (await import('./sceneCardInteractions.js?v=20260829-production-v269')).bindSceneCards(host, context);
