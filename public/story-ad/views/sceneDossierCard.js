import { escapeHtml, mediaPreview, setButtonBusy, toast } from '../components/ui.js?v=20260828-production-v239b';
import { sceneRuntimeFailureMarkup } from './sceneRuntimeFailureView.js?v=20260828-production-v239b';
...
export function bindSceneDossierCard(scope, item = {}) {
  ...
  button.addEventListener('click', async () => {
    try {
      ...
      const exporter = await import('./sceneDossierExport.js?v=20260828-production-v239b');
