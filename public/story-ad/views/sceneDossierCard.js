import { escapeHtml, mediaPreview, setButtonBusy, toast } from '../components/ui.js?v=20260901-production-v372';
import { sceneRuntimeFailureMarkup } from './sceneRuntimeFailureView.js?v=20260901-production-v372';
import { publicSceneQaReason, sceneQaFailureDetails, sceneQaPublicState, sceneQaRows } from './sceneQaPublicState.js?v=20260901-production-v372';
...
export function bindSceneDossierCard(scope, item = {}) {
  ...
  button.addEventListener('click', async () => {
    try {
      ...
      const exporter = await import('./sceneDossierExport.js?v=20260901-production-v372');
