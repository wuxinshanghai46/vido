import { escapeHtml, mediaPreview, setButtonBusy, toast } from '../components/ui.js?v=20260826-production-v233a';
...
export function bindSceneDossierCard(scope, item = {}) {
  ...
  button.addEventListener('click', async () => {
    try {
      ...
      const exporter = await import('./sceneDossierExport.js?v=20260826-production-v233a');
