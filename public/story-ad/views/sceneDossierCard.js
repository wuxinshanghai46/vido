...
import { sceneRuntimeFailureMarkup } from './sceneRuntimeFailureView.js?v=20260831-production-v334';
import { publicSceneQaReason, sceneQaFailureDetails, sceneQaPublicState, sceneQaRows } from './sceneQaPublicState.js?v=20260831-production-v334';
...
export function bindSceneDossierCard(scope, item = {}) {
  ...
  button.addEventListener('click', async () => {
    try {
      ...
      const exporter = await import('./sceneDossierExport.js?v=20260831-production-v334');
