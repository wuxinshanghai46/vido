import { escapeHtml, mediaPreview, setButtonBusy, toast } from '../components/ui.js?v=20260822-knowledge-director-learning-v137';
...
export function bindSceneDossierCard(scope, item = {}) {
  ...
  button.addEventListener('click', async () => {
    try {
      ...
      const exporter = await import('./sceneDossierExport.js?v=20260822-knowledge-director-learning-v137');
