import { escapeHtml, mediaPreview, setButtonBusy, toast } from '../components/ui.js?v=20260829-production-v267';
import { sceneRuntimeFailureMarkup } from './sceneRuntimeFailureView.js?v=20260829-production-v267';
import { publicSceneQaReason, sceneQaFailureDetails, sceneQaPublicState, sceneQaRows } from './sceneQaPublicState.js?v=20260829-production-v267';
...
export function bindSceneDossierCard(scope, item = {}) {
  ...
  button.addEventListener('click', async () => {
    try {
      ...
      const exporter = await import('./sceneDossierExport.js?v=20260829-production-v267');
