...
import { escapeHtml, setButtonBusy, toast } from '../components/ui.js?v=20260804-reference-reanalysis-v12';
...
function ensureStyles() {
  ...
  link.id = STYLE_ID;
  link.rel = 'stylesheet';
  link.href = '/story-ad/reference-understanding.css?v=20260804-reference-reanalysis-v12';
...
export function mountReferenceUnderstanding(host, options = {}) {
  ...
  const click = async event => {
    ...
    if (!await confirmDialog('确认后，这一版本将成为人物、场景、剧情、分镜和导演台的共同权威输入。本操作不会触发任何生成或付费调用。', {
      title: '确认参考理解结果',
      confirmText: '确认当前版本',
    })) return;
    try {
