import { sketchBatchMarkup } from './storyboardImageReview.js?v=20260904-production-v431';
import { request } from '../api.js?v=20260904-production-v431';
import { elapsedTimeTag, emptyState, escapeHtml, mediaPreview, setButtonBusy, toast } from '../components/ui.js?v=20260904-production-v431';
...
import { generationModelPickerPlaceholder } from './generationModelPlaceholder.js?v=20260904-production-v431';
import { openStoryboardPromptEditor, referenceItemsFor, sketchReferenceMarkup } from './storyboardPromptEditorDialog.js?v=20260904-production-v431';
...
export async function mount(host, context) {
  if (context.route?.params?.get('stage') === 'shot') {
    const shotDesigner = await import('./shotDesignerView.js?v=20260904-production-v431');
  ...
  const primaryAction = !isReferenceDraft && !(completedHistorical && !sketchGate.ready)
    ...
    : '';
  host.innerHTML = `<link rel="stylesheet" href="/story-ad/storyboard-images.css?v=20260904-production-v431">
