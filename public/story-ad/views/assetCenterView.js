...
import { bindMediaLightbox, emptyState, escapeHtml, setButtonBusy, toast } from '../components/ui.js?v=20260813-ui-v228';
import { confirmDialog } from '../components/dialog.js?v=20260813-ui-v228';
import { openActorLibrary, openRealPersonFlow } from './assetCenterPersonSources.js?v=20260813-ui-v228';
import { authorizeBillingReviews, confirmBillingAwareAction } from './assetCenterBillingRetry.js?v=20260813-ui-v228';
import { collectPersonLookValues, renderPersonLookEditors, renderPersonLookTiles } from './assetCenterPersonLooks.js?v=20260813-ui-v228';
import { legacyDossierBoard, mediaSection } from './assetCenterDossierSections.js?v=20260813-ui-v228';
import { assetCardMedia } from './sceneDossierCard.js?v=20260813-ui-v228';
import { assertSavedPerson, personAgeDisplay, personAssetState, personLookSummary } from './assetCenterPersonState.js?v=20260813-ui-v228';
import { bindPersonEvolutionForm, collectPersonEvolutionValues, renderPersonEvolutionEditor, renderPersonEvolutionSummary } from './assetCenterPersonEvolution.js?v=20260813-ui-v228';
import { assetPlanBlockedView } from './assetCenterPlanningDetailsStatus.js?v=20260813-ui-v228';
const GROUPS = [
  ['people', '人物'],
  ['animals', '动物'],
  ['products', '商品 / 展示主体'],
...
let planningDetailsPromise; async function openDrawer(item, group, handlers = {}) {
  planningDetailsPromise ||= import('./assetCenterPlanningDetails.js?v=20260813-ui-v228');
...
export async function mount(host, context) {
  ...
  const runAssist = async (kind, ...args) => (await (assistModulePromise ||= import('./assetCenterAssist.js?v=20260813-ui-v228'))).createAssetAssistHandlers(bundle)[kind](...args);
