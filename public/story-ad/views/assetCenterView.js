...
import { bindMediaLightbox, emptyState, escapeHtml, setButtonBusy, toast } from '../components/ui.js?v=20260814-reference-world-recognition-v51';
import { confirmDialog } from '../components/dialog.js?v=20260814-reference-world-recognition-v51';
import { openActorLibrary, openRealPersonFlow } from './assetCenterPersonSources.js?v=20260814-reference-world-recognition-v51';
...
import { collectPersonLookValues, renderPersonLookTiles } from './assetCenterPersonLooks.js?v=20260814-reference-world-recognition-v51';
import { legacyDossierBoard, mediaSection } from './assetCenterDossierSections.js?v=20260814-reference-world-recognition-v51';
...
let planningDetailsPromise; let personFormPromise; async function openDrawer(item, group, handlers = {}) {
  planningDetailsPromise ||= import('./assetCenterPlanningDetails.js?v=20260814-reference-world-recognition-v51');
  personFormPromise ||= import('./assetCenterPersonForm.js?v=20260814-reference-world-recognition-v51');
...
export async function mount(host, context) {
  ...
  const runAssist = async (kind, ...args) => (await (assistModulePromise ||= import('./assetCenterAssist.js?v=20260814-reference-world-recognition-v51'))).createAssetAssistHandlers(bundle)[kind](...args);
