...
import { bindMediaLightbox, emptyState, escapeHtml, setButtonBusy, toast } from '../components/ui.js?v=20260814-sr14-v22';
import { confirmDialog } from '../components/dialog.js?v=20260814-sr14-v22';
import { openActorLibrary, openRealPersonFlow } from './assetCenterPersonSources.js?v=20260814-sr14-v22';
import { authorizeBillingReviews, confirmBillingAwareAction } from './assetCenterBillingRetry.js?v=20260814-sr14-v22';
import { collectPersonLookValues, renderPersonLookEditors, renderPersonLookTiles } from './assetCenterPersonLooks.js?v=20260814-sr14-v22';
import { legacyDossierBoard, mediaSection } from './assetCenterDossierSections.js?v=20260814-sr14-v22';
...
let planningDetailsPromise; async function openDrawer(item, group, handlers = {}) {
  planningDetailsPromise ||= import('./assetCenterPlanningDetails.js?v=20260814-sr14-v22');
...
export async function mount(host, context) {
  ...
  const runAssist = async (kind, ...args) => (await (assistModulePromise ||= import('./assetCenterAssist.js?v=20260814-sr14-v22'))).createAssetAssistHandlers(bundle)[kind](...args);
