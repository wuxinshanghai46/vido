...
import { bindMediaLightbox, emptyState, escapeHtml, setButtonBusy, toast } from '../components/ui.js?v=20260814-plan-authority-repair-v52';
import { confirmDialog } from '../components/dialog.js?v=20260814-plan-authority-repair-v52';
import { openActorLibrary, openRealPersonFlow } from './assetCenterPersonSources.js?v=20260814-plan-authority-repair-v52';
...
import { collectPersonLookValues, renderPersonLookTiles } from './assetCenterPersonLooks.js?v=20260814-plan-authority-repair-v52';
import { legacyDossierBoard, mediaSection } from './assetCenterDossierSections.js?v=20260814-plan-authority-repair-v52';
import { assetCardMedia } from './sceneDossierCard.js?v=20260814-plan-authority-repair-v52';
import { assertSavedPerson, personAgeDisplay, personAssetState, personLookSummary } from './assetCenterPersonState.js?v=20260814-plan-authority-repair-v52';
import { bindPersonEvolutionForm, collectPersonEvolutionValues, renderPersonEvolutionSummary } from './assetCenterPersonEvolution.js?v=20260814-plan-authority-repair-v52';
...
let planningDetailsPromise; let personFormPromise; async function openDrawer(item, group, handlers = {}) {
  planningDetailsPromise ||= import('./assetCenterPlanningDetails.js?v=20260814-plan-authority-repair-v52');
  personFormPromise ||= import('./assetCenterPersonForm.js?v=20260814-plan-authority-repair-v52');
...
export async function mount(host, context) {
  ...
  const runAssist = async (kind, ...args) => (await (assistModulePromise ||= import('./assetCenterAssist.js?v=20260814-plan-authority-repair-v52'))).createAssetAssistHandlers(bundle)[kind](...args);
