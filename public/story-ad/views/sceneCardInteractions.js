...
import { confirmBillingAwareAction } from './assetCenterBillingRetry.js?v=20260827-production-v233f';
...
export function bindSceneCards(host, context) {
  ...
  host.querySelectorAll('[data-scene-card]').forEach(card => {
    ...
    const promise = import('./scenePromptEditor.js?v=20260827-production-v233f').then(module => {
