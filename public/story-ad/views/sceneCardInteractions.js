import { setButtonBusy, toast } from '../components/ui.js?v=20260827-production-v236g';
import { confirmBillingAwareAction } from './assetCenterBillingRetry.js?v=20260827-production-v236g';
import { sceneNeedsGeneration } from './sceneDossierCard.js?v=20260827-production-v236g';
import { sceneGenerationSettingsMarkup } from './sceneDossierCardSettings.js?v=20260827-production-v236g';
...
export function bindSceneCards(host, context) {
  ...
  host.querySelectorAll('[data-scene-card]').forEach(card => {
    ...
    const promise = import('./scenePromptEditor.js?v=20260827-production-v236g').then(module => {
