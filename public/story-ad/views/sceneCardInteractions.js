...
import { confirmBillingAwareAction } from './assetCenterBillingRetry.js?v=20260826-production-v233b';
...
export function bindSceneCards(host, context) {
  ...
  host.querySelectorAll('[data-scene-card]').forEach(card => {
    ...
    const promise = import('./scenePromptEditor.js?v=20260826-production-v233b').then(module => {
