...
import { confirmBillingAwareAction } from './assetCenterBillingRetry.js?v=20260827-production-v237a';
import { sceneNeedsGeneration } from './sceneDossierCard.js?v=20260827-production-v237a';
import { sceneGenerationSettingsMarkup } from './sceneDossierCardSettings.js?v=20260827-production-v237a';
...
export function bindSceneCards(host, context) {
  ...
  host.querySelectorAll('[data-scene-card]').forEach(card => {
    ...
    const promise = import('./scenePromptEditor.js?v=20260827-production-v237a').then(module => {
